...
public class DateUtil {
	 ...
	 * @return String
	 */
	public static String getDurationMillis(String startDate, String endDate, String pattern) {
		int dur = 0;
		String durStr = "0";
		try {
			DateTimeFormatter fmt = DateTimeFormat.forPattern(pattern);
			...
			int startMillis = (int) startDateTime.getMillis();
			int endMillis = (int) endDateTime.getMillis();
			
			dur = endMillis- startMillis;

			durStr = Integer.toString(dur);
		}catch(Exception e) {

...
public class DigestUtil {
	...
	public static String encodeCharset(String str, String charsetName) {
		...
		try {
			...
			throw new IllegalArgumentException("UnsupportedEncodingException : " + e.getMessage(), e);
		}
		return result;
	}
...
//	}
	...
	public static String encodePassword(String password, String algorithm) {
		...
		try {
			...
			throw new IllegalArgumentException("NoSuchAlgorithmException : " + e.getMessage(), e);
		}

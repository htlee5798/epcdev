 ...
 *   수정일      수정자           수정내용
 *  -------    --------    ---------------------------
 * 2015. 12. 10. 오후 2:32:38 CSG
 *
 * @Copyright (C) 2000 ~ 2011 lottemart All right reserved.
 * </pre>
 */

public class NEDMWEB0230VO extends PagingVO implements Serializable {

	private static final Logger logger = LoggerFactory.getLogger(NEDMWEB0230VO.class);

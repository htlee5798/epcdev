...
public class PSCMORD0007VO implements Serializable {

	/**
	 * 클러스터 시스템에서의 직력화 아이디
	 */
	private static final long serialVersionUID = -4419489738214547134L;
	...
	public String getTotSellAmt() {
		return totSellAmt;
	}

	public void setTotSellAmt(String totSellAmt) {
		this.totSellAmt = totSellAmt;
	}
}

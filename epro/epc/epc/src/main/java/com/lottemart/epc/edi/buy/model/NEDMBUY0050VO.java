...
/**
 * @Class Name : NEDMBUY0050VO
 * @Description : 매입정보 전표상세별 조회 VO Class
 ...
 * </pre>
 */
public class NEDMBUY0050VO implements Serializable {
	...
	public String getStrNmT() {
		return strNmT;
	}

	public void setStrNmT(String strNmT) {
		this.strNmT = strNmT;
	}

...
import com.lottemart.epc.statistics.dao.PSCMSTA0004Dao;
 ...
 * </pre>
 */
@Service("PSCMSTA0004Service")
public class PSCMSTA0004ServiceImpl implements PSCMSTA0004Service {
	
	@Autowired
	private PSCMSTA0004Dao pscmsta0004Dao;
	...
	public List<DataMap> selectAsianaMileageList(PSCMSTA0004SearchVO searchVO) throws Exception {
		return pscmsta0004Dao.getAsianaMileageList(searchVO);
	}
	
	/**
	 * Desc : 아시아나정산관리 목록 조회 메소드
	 * @Method Name : selectAsianaMileageSum
	 * @param searchVO
	 * @return
	 * @throws Exception
	 * @param 
	...
	public DataMap selectAsianaMileageSum(PSCMSTA0004SearchVO searchVO) throws Exception {
		return pscmsta0004Dao.getAsianaMileageSum(searchVO);
	}
	...
	public List<DataMap> selectAsianaMileageListExcel(PSCMSTA0004SearchVO searchVO) throws Exception {
		return pscmsta0004Dao.getAsianaMileageListExcel(searchVO);
	}
}

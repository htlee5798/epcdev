...
public class NEDMUSP0010VO implements Serializable {

	
	private static final long serialVersionUID = -6918711902569942487L;


	public NEDMUSP0010VO () {}
	
	//crud파람
	private List<NEDMUSP0010VO> updateParam;
	...
	/** 미납비율 */ 
	private String usplyRatio;


	public List<NEDMUSP0010VO> getUpdateParam() {
		return updateParam;
	}

	public void setUpdateParam(List<NEDMUSP0010VO> updateParam) {
	...
	public String getUsplyRatio() {
		return usplyRatio;
	}

	public void setUsplyRatio(String usplyRatio) {
		this.usplyRatio = usplyRatio;
	}

 ...
 */
@Controller
public class NEDMPAY0130Controller {

	@Autowired
	private NEDMPAY0130Service nedmpay0130Service;
	...
	private ConfigurationService config;
		 ...
		 * @return
		 */
		@RequestMapping(value = "/edi/payment/NEDMPAY0130.do", method = {RequestMethod.GET,RequestMethod.POST})
		public String credLedStore(Locale locale,  ModelMap model,HttpServletRequest request) {
			...
			return "/edi/payment/NEDMPAY0130";
		}
		 ...
		 * @return
		 */
		@RequestMapping(value = "/edi/payment/NEDMPAY0130Select.json", method = RequestMethod.POST)
		public @ResponseBody Map<String, Object> selectCredLedStore(@RequestBody NEDMPAY0130VO map,HttpServletRequest request) throws Exception {
			// session 접근 N개의 협력사코드(VEN_CD) -------------------------------
			EpcLoginVO epcLoginVO = (EpcLoginVO) request.getSession().getAttribute(config.getString("lottemart.epc.session.key"));
			map.setVenCds(epcLoginVO.getVendorId());
			Map<String, Object> resultMap = new HashMap<String, Object>();
			List<NEDMPAY0130VO> paymentList = nedmpay0130Service.selectCredLedStoreInfo(map);
		 ...
		 * @return
		 */
		@RequestMapping(value = "/edi/payment/NEDMPAY0130Text.do", method = RequestMethod.POST)
		public void createTextCredLedStore(NEDMPAY0130VO map,HttpServletRequest request, HttpServletResponse response) throws Exception {
			...
			nedmpay0130Service.createTextCredLedStore(map,request,response);

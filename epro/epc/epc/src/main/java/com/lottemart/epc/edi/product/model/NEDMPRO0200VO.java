...
public class NEDMPRO0200VO extends PagingVO  {
	...
	private String[] nutCd;         // 영양성분코드 복수
	private String[] nutNm;         // 영양성분이름 복수
	private String[] nutAmt;        // 영양성분값 복수
	...
	public String[] getNutNm() {
		return nutNm;
	}
	
	public void setNutNm(String[] nutNm) {
		this.nutNm = nutNm;
	}
	...
	public void setGrpAttrValNm(String[] nutAmt) {
		this.nutAmt = nutAmt;
	}

...
/**
 * @Class Name : PSCMSTA0012Controller
 ...
 */
@Controller
public class PSCMSTA0012Controller {

	private static final Logger logger = LoggerFactory.getLogger(PSCMSTA0012Controller.class);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/statistics/coochaList.do")
	public String coochaList(@ModelAttribute("searchVO") PSCMSTA0001SearchVO searchVO, HttpServletRequest request,ModelMap model) throws Exception {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/statistics/selectCoochaList.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/statistics/selectCoochaListExcel.do")

...
@Controller
public class PSCMSTA0016Controller {
	...
	@RequestMapping(value ="/statistics/gasStationPickUp.do")
	public String gasStationPickUp(@ModelAttribute("searchVO") PSCMSTA0014VO searchVO, HttpServletRequest request, ModelMap model ) throws Exception {
		...
		List<DataMap> pickUpTimeList = pscmsta0014Service.selectPickUpTime();
		model.addAttribute("pickUpTimeList", pickUpTimeList);

		model.addAttribute("paginationInfo", paginationInfo);

		return "statistics/PSCMSTA0016";
	}

	@RequestMapping(value ="/statistics/selectGasStationPickUp.do")
	public String selectGasStationPickUp(@ModelAttribute("searchVO") PSCMSTA0014VO searchVO, HttpServletRequest request ,ModelMap model) throws Exception {
		...
		List<DataMap> list = pscmsta0014Service.selectGasStationPickUp(searchVO);
	...
	@RequestMapping(value ="/statistics/gasStationPickUpExcel.do")
	  public String gasStationPickUpExcel(@ModelAttribute("searchVO") PSCMSTA0014VO searchVO, HttpServletRequest request ,ModelMap model) throws Exception {
		...
		return "statistics/PSCMSTA001602";
	}

	@RequestMapping(value ="/statistics/saveGasStationPickUp.do")
	...
	@RequestMapping(value ="/statistics/pickUpListExcelByGas.do")
	  public String pickUpListExcelByGas(@ModelAttribute("searchVO") PSCMSTA0014VO searchVO, HttpServletRequest request ,ModelMap model) throws Exception {
		...
		List<DataMap> list = pscmsta0014Service.pickUpListExcelByGas(paramMap);
		model.addAttribute("list", list);
		return "statistics/PSCMSTA001601";
	}

	@RequestMapping(value ="/statistics/excgOrRtnExcelByGas.do")

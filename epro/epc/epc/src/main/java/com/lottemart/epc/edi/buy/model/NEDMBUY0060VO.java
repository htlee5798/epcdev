 ...
 * @Description : 매입정보 점포상품별 조회 VO Class
 ...
 * </pre>
 */
public class NEDMBUY0060VO extends PagingVO implements Serializable {

	private static final long serialVersionUID = 6338083734002146496L;		//필수 [각 VO Class 마다 동일하게 생성 금지]
	...
	private String danwi;					// 판매마스터(0:EA,1:BOX,2:KG,3:묶음,4:행거,5:100G,6:10G,7:G) 
	...
	private String recordCnt;				// 한페이지에 보여줄 게시물 건수

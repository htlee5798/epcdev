...
@Repository("pedmweb0005Dao")
public class PEDMWEB0005Dao extends AbstractDAO {
	...
	public int selectRtnProdCnt(EdiRtnProdVO vo) {
		return ((Integer) getSqlMapClientTemplate().queryForObject("PEDMWEB0005.EDI_RETURN_PROD_DATA_02_01", vo)).intValue();
	}
	...
	public int selectRtnProdDuplicateCnt(EdiRtnProdVO vo) {
		return ((Integer) getSqlMapClientTemplate().queryForObject("PEDMWEB0005.EDI_RETURN_PROD_DATA_02_02", vo)).intValue();
	}
	...
	public int saveRtnProdMst(EdiRtnProdVO vo) throws Exception{
		return getSqlMapClientTemplate().update("PEDMWEB0005.EDI_RETURN_PROD_DATA_03", vo);
	}
	...
	public int saveRtnProdList(EdiRtnProdVO vo) throws Exception{
		return getSqlMapClientTemplate().update("PEDMWEB0005.EDI_RETURN_PROD_DATA_04", vo);
	}
	...
	public int saveRtnrodSum(EdiRtnProdVO vo) throws Exception{
		return (Integer)getSqlMapClientTemplate().update("PEDMWEB0005.EDI_RETURN_PROD_DATA_05", vo);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public EdiRtnProdVO selectDayRtnProdSum2(SearchWebOrder vo) {
		// TODO Auto-generated method stub
		return (EdiRtnProdVO)getSqlMapClientTemplate().queryForObject("PEDMWEB0005.EDI_RETURN_PROD_SELECT_01_03", vo);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<EdiRtnProdVO> selectDayRtnProdList2(SearchWebOrder vo)  throws Exception{
		// TODO Auto-generated method stub
		return (List<EdiRtnProdVO>)getSqlMapClientTemplate().queryForList("PEDMWEB0005.EDI_RETURN_PROD_SELECT_02_02", vo);
	}
	...
	public List<EdiRtnProdVO> selectDayRtnProdListSend(SearchWebOrder vo)  throws Exception{
		// TODO Auto-generated method stub
		return (List<EdiRtnProdVO>)getSqlMapClientTemplate().queryForList("PEDMWEB0005.EDI_RETURN_PROD_SELECT_02_SEND", vo);
	}
	...
	public List<EdiRtnProdVO> selectDayRtnProdSumList(SearchWebOrder vo)  throws Exception{
		// TODO Auto-generated method stub
		return (List<EdiRtnProdVO>)getSqlMapClientTemplate().queryForList("PEDMWEB0005.EDI_RETURN_PROD_SELECT_03", vo);
	}
	...
	public void deleteRtnrodList(EdiRtnProdVO param ) throws Exception{
		getSqlMapClientTemplate().delete("PEDMWEB0005.EDI_RETURN_PROD_DELETE_02", param);
	}
		...
		getSqlMapClientTemplate().execute(new SqlMapClientCallback(){
			public Object doInSqlMapClient(SqlMapExecutor executor) throws SQLException {
		    	...
		    	for ( EdiRtnProdVO  rtnProd  : rtnDeleteList ) {
		    		executor.delete("PEDMWEB0005.EDI_RETURN_PROD_DELETE_01", rtnProd);
		    	}
	...
	public EdiRtnProdVO saveCallSendReturnProd(EdiRtnProdVO param )  throws Exception, SQLException {
		this.getSqlMapClient().queryForObject("PEDMWEB0005.EID_RETURN_PROCEDURE_01",param);
		return param;
	}
	...
	public HashMap<String, Object> saveCallSendReturnProdHash(HashMap param )  throws Exception, SQLException {
		...
		hmap.put("O_PROC_CMT","");
		*/
		return (HashMap)getSqlMapClientTemplate().queryForObject("PEDMWEB0005.EID_RETURN_PROCEDURE_01",param);
	}
	...
	public void saveTedPoRrlProdBatch(final EdiRtnProdListVO rtnDeleteList) throws Exception, SQLException {
		getSqlMapClientTemplate().execute(new SqlMapClientCallback(){
			public Object doInSqlMapClient(SqlMapExecutor executor) throws SQLException {
		    	executor.startBatch();
		    	for ( EdiRtnProdVO  rtnProd  : rtnDeleteList ) {
		    		executor.update("PEDMWEB0005.EDI_RETURN_PROD_UPDATE_01", rtnProd);
		    	}
		    	return new Integer(executor.executeBatch());
			}
		});
	...
	public int saveTedPoRrlMst(SearchWebOrder  vo) throws Exception, SQLException {
		return (Integer)getSqlMapClientTemplate().update("PEDMWEB0005.EDI_RETURN_PROD_UPDATE_02", vo);
	}
	...
	public List<EdiRtnProdVO> selectDayRtnList(SearchWebOrder vo)  throws Exception{
		// TODO Auto-generated method stub
		return (List<EdiRtnProdVO>)getSqlMapClientTemplate().queryForList("PEDMWEB0005.EDI_RETURN_SELECT_01", vo);
	}
	...
	public EdiRtnProdVO selectDayRtnSum(SearchWebOrder vo) {
		// TODO Auto-generated method stub
		return (EdiRtnProdVO)getSqlMapClientTemplate().queryForObject("PEDMWEB0005.EDI_RETURN_SELECT_02", vo);
	}
	...
	public int selectDayRtnListTotCnt(SearchWebOrder vo) {
		return ((Integer) getSqlMapClientTemplate().queryForObject("PEDMWEB0005.EDI_RETURN_SELECT_03", vo)).intValue();
	}
	...
	public String selectNewRtnReqNo() {
		return (String)selectByPk("PEDMWEB0005.selectNewRtnReqNo", null);
	}
	
	/** 반품 등록번호  조회 */
	public String selectRtnReqNo(EdiRtnProdVO vo) {
		return (String)selectByPk("PEDMWEB0005.selectRtnReqNo", vo);
	}
	
	// 반품 일괄 등록 카운트 조회
	@SuppressWarnings("deprecation")
	public int selectRtnPackListTotCnt(SearchWebOrder vo) {
		return ((Integer) getSqlMapClientTemplate().queryForObject("PEDMWEB0005.selectRtnPackListTotCnt", vo)).intValue();
	}
	...
	public List<EdiRtnPackVO> selectRtnPackList(SearchWebOrder vo) {
		// TODO Auto-generated method stub
		return (List<EdiRtnPackVO>)getSqlMapClientTemplate().queryForList("PEDMWEB0005.selectRtnPackList", vo);
	}
	...
	public EdiRtnPackVO selectRtnPackCntSum(SearchWebOrder vo) {
		// TODO Auto-generated method stub
		return (EdiRtnPackVO)getSqlMapClientTemplate().queryForObject("PEDMWEB0005.selectRtnPackCntSum", vo);
	}
	
	/** 파일구분 코드 생성 */
	public String selectNewRtnPackDivnCd() {
		return (String)selectByPk("PEDMWEB0005.selectNewRtnPackDivnCd", null);
	}

	/** 파일 그룹 코드 생성 */
	public String selectNewRtnFileGrpCd(String venCd) {
		return (String)selectByPk("PEDMWEB0005.selectNewRtnFileGrpCd", venCd);
	}
		...
		getSqlMapClientTemplate().execute(new SqlMapClientCallback(){
			public Object doInSqlMapClient(SqlMapExecutor executor) throws SQLException {
		    	...
		    	for ( EdiRtnPackVO  ord : packList ) {
		    		executor.insert("PEDMWEB0005.insertRtnPackInfo", ord);
		        }
		    	return new Integer(executor.executeBatch());
			}
		});
	...
	public void updateRtnPackInfo(EdiRtnPackVO vo) throws Exception, SQLException {
		update("PEDMWEB0005.updateRtnPackInfo", vo);
	}
	...
	public void updateRtnPackState(String packDivnCd) throws SQLException {
		update("PEDMWEB0005.updateRtnPackState", packDivnCd);
	}
	
	/** 엑셀 반품요청 정보 삭제 */
	public void deleteExcelRtnInfo(EdiRtnPackVO vo) throws SQLException{
		this.delete("PEDMWEB0005.deleteExcelRtnInfo", vo);
	}
	
	//엑셀 반품요청 오류카운트 조회
	@SuppressWarnings("deprecation")
	public int selectRtnExcelErrorCnt(EdiRtnPackVO vo) {
		return ((Integer) getSqlMapClientTemplate().queryForObject("PEDMWEB0005.selectRtnExcelErrorCnt", vo)).intValue();
	}
	
	//엑셀 반품요청 중복 카운트 조회
	@SuppressWarnings("deprecation")
	public int selectRtnExcelDuplCnt(EdiRtnPackVO vo) {
		return ((Integer) getSqlMapClientTemplate().queryForObject("PEDMWEB0005.selectRtnExcelDuplCnt", vo)).intValue();
	}
	
	// 업체반품요청 상품정보에 기 등록된 데이터가 있는지 확인.
	@SuppressWarnings("deprecation")
	public int selectRtnDuplCnt(EdiRtnPackVO vo) {
		return ((Integer) getSqlMapClientTemplate().queryForObject("PEDMWEB0005.selectRtnDuplCnt", vo)).intValue();
	}
	
	@SuppressWarnings({ "unchecked", "deprecation" })
	public List<EdiRtnPackVO> selectRtnPackStrInfo(EdiRtnPackVO vo) {
		// TODO Auto-generated method stub
		return (List<EdiRtnPackVO>)getSqlMapClientTemplate().queryForList("PEDMWEB0005.selectRtnPackStrInfo", vo);
	}
	
	@SuppressWarnings({"deprecation", "unchecked" })
	public List<EdiRtnPackVO> selectRtnPackInfoList(EdiRtnPackVO vo) {
		// TODO Auto-generated method stub
		return (List<EdiRtnPackVO>)getSqlMapClientTemplate().queryForList("PEDMWEB0005.selectRtnPackInfoList", vo);
	}
	...
	public void insertRtnExcelMstInfo(EdiRtnProdVO vo) throws DataAccessException {
		insert("PEDMWEB0005.insertRtnExcelMstInfo", vo);
	}
		...
		getSqlMapClientTemplate().execute(new SqlMapClientCallback(){
			public Object doInSqlMapClient(SqlMapExecutor executor) throws SQLException {
		    	...
		    	for ( EdiRtnPackVO  ord : ordList ) {
		    		executor.insert("PEDMWEB0005.insertRtnExcelProdInfo", ord);
		    	}
		    	return new Integer(executor.executeBatch());
			}
		});
	...
	public void updateExcelRtnMstSum(EdiRtnProdVO vo) throws SQLException {
		update("PEDMWEB0005.updateExcelRtnMstSum", vo);
	}
	
	/** 엑셀 반품요청 정보 삭제 : 저장 성공시*/
	public void deleteRtnPackInfo(EdiRtnPackVO vo) throws SQLException{
		this.delete("PEDMWEB0005.deleteRtnPackInfo", vo);
	}

...
public class NEDMINV0030VO implements Serializable {


	private static final long serialVersionUID = 6766182773315305941L;

	public NEDMINV0030VO() {}
	...
	public String getStroDy() {
		return stroDy;
	}

	public void setStroDy(String stroDy) {
		this.stroDy = stroDy;
	}

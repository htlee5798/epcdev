 ...
 */
@Controller
public class SRMEVL0030Controller {

	private static final Logger logger = LoggerFactory.getLogger(SRMEVL0030Controller.class);

	@Autowired
	private SRMEVL0030Service srmevl0030Service;
	 ...
	 * @return
	 */
	@RequestMapping(value = "/edi/evl/SRMEVL0030.do")
	public String SRMEVL0030() throws Exception {
		return "/edi/srm/SRMEVL0030";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/edi/evl/selectQualityEvaluationList.json", method = RequestMethod.POST)
	public @ResponseBody Map<String,Object> selectQualityEvaluationList(@RequestBody SRMEVL0030VO vo, HttpServletRequest request) throws Exception {
		return srmevl0030Service.selectQualityEvaluationList(vo, request);
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/edi/evl/selectQualityEvaluationListExcel.do")
	public void selectQualityEvaluationListExcel(Model model, SRMEVL0030VO vo, HttpServletRequest request, HttpServletResponse response) throws Exception {
		model.addAttribute("list", srmevl0030Service.selectQualityEvaluationListExcel(vo, request));
		...
		List<SRMEVL0030VO>	resultItemList= srmevl0030Service.selectQualityEvaluationListExcel(vo, request);
...
//		CreationHelper createHelper = workbook.getCreationHelper();
		...
		int no = 1;
		while (iter.hasNext()) {
			SRMEVL0030VO item = (SRMEVL0030VO) iter.next();
			if (item == null) {
				continue;
			}
	 ...
	 * @throws Exception
     */
	@RequestMapping(value = "/edi/evl/receiptPopup.do")
	public String receiptPopup(Model model, SRMEVL0030VO vo, HttpServletRequest request) throws Exception {
		model.addAttribute("vo", vo);
		model.addAttribute("srmComp", srmevl0030Service.selectQualityEvaluationCompInfo(vo, request));
		return "/edi/srm/SRMEVL003001";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/edi/evl/updateQualityEvaluationCheckDate.json", method = RequestMethod.POST)
	public @ResponseBody Map<String,Object> updateQualityEvaluationCheckDate(@RequestBody SRMEVL0030VO vo, HttpServletRequest request) throws Exception {
		if(vo == null) return null;
		return srmevl0030Service.updateQualityEvaluationCheckDate(vo, request);
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/edi/evl/SRMEVL0031Popup.do")
	public String SRMEVL0031() throws Exception {
		return "/edi/srm/SRMEVL0031";
	}

...
public class NEDMPRO0080VO extends PagingVO implements Serializable {

	private static final long serialVersionUID = 1L;
	
	private String srchEntpCd;      // 협력업체코드
	private String srchL1Cd;        // 대분류
	private String srchSellCd;      // 협력업체코드
	private String[] srchSellCds;   // 검색할 복수의 판매코드
	private String srchAprvStat;    // 심사진행상태
	private String[] venCds;        // 협력업체 코드 배열
	
	private String aprvStat;        // 상품 속성요청 진행단계

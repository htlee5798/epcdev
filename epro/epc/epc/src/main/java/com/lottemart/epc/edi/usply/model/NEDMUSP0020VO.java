...
public class NEDMUSP0020VO implements Serializable {

	
	private static final long serialVersionUID = -6918711902569942487L;


	public NEDMUSP0020VO () {}
	
	//crud파람
	private List<NEDMUSP0020VO> updateParam;
	...
	public List<NEDMUSP0020VO> getUpdateParam() {
		return updateParam;
	}

	public void setUpdateParam(List<NEDMUSP0020VO> updateParam) {

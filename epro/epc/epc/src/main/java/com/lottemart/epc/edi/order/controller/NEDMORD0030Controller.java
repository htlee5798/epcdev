 ...
 */
@Controller
public class NEDMORD0030Controller {

	@Autowired
	private NEDMORD0030Service nedmord0030Service;
	...
	private ConfigurationService config;
		 ...
		 * @return
		 */
		@RequestMapping(value = "/edi/order/NEDMORD0030.do", method = {RequestMethod.GET,RequestMethod.POST})
		public String junpyoDetail(Locale locale,  ModelMap model,HttpServletRequest request) {
			...
			String returnPage = "/edi/order/NEDMORD0030";
			return returnPage;
		}
		 ...
		 * @return
		 */
		@RequestMapping(value = "/edi/order/NEDMORD0030Select.json", method = RequestMethod.POST)
		public String T_selectJunpyoDetail(ModelMap model,@RequestBody NEDMORD0030VO map, HttpServletRequest request) throws Exception {
			...
			List<NEDMORD0030VO> 	orderList 	= 	nedmord0030Service.selectJunpyoDetailInfo(map);

			model.addAttribute("orderList", orderList);

			return "/edi/order/NEDMORD0030AJAX";
		}
		 ...
		 * @return
		 */
		@RequestMapping(value = "/edi/order/NEDMORD0030Text.do", method = RequestMethod.POST)
		public void createTextJunpyoDetail(NEDMORD0030VO map,HttpServletRequest request, HttpServletResponse response) throws Exception {
			...
			nedmord0030Service.createTextJunpyoDetail(map,request,response);

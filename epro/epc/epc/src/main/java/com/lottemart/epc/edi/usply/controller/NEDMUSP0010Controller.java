 ...
 */
@Controller
public class NEDMUSP0010Controller {
	//private final String version = "new"; //new old
	@Autowired
	private NEDMUSP0010Service nedmusp0010Service;
	 ...
	 * @return
	 */
	@RequestMapping(value = "/edi/usply/NEDMUSP0010.do", method = RequestMethod.GET)
	public String day(Locale locale,  ModelMap model,HttpServletRequest request) {

		String returnPage = "/edi/usply/NEDMUSP0010";
	 ...
	 * @return
	 */
	@RequestMapping(value = "/edi/usply/NEDMUSP0010Select.json", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> selectDay(@RequestBody NEDMUSP0010VO map, HttpServletRequest request) throws Exception {
		...
		List<NEDMUSP0010VO> 	usplyList 	= 	nedmusp0010Service.selectDayInfo(map);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/edi/usply/NEDMUSP0010Text.do", method=RequestMethod.POST)
    public void createTextOrdProdList(NEDMUSP0010VO vo, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		nedmusp0010Service.createTextOrdProdList(vo, request, response);
	}
}

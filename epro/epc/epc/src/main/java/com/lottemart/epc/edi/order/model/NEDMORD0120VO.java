...
public class NEDMORD0120VO implements Serializable {

	
	private static final long serialVersionUID = -6918711902569942487L;


	public NEDMORD0120VO () {}
	//crud파람
	private NEDMORD0120VO[] arrParam;
	...
	public NEDMORD0120VO[] getArrParam() {
		if (this.arrParam != null) {
			NEDMORD0120VO[] ret = new NEDMORD0120VO[arrParam.length];
	...
	public void setArrParam(NEDMORD0120VO[] arrParam) {
		if (arrParam != null) {
			 this.arrParam = new NEDMORD0120VO[arrParam.length];			 
			 for (int i = 0; i < arrParam.length; ++i) {

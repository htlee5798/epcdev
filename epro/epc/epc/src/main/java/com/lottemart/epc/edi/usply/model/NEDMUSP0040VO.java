...
public class NEDMUSP0040VO implements Serializable {

	
	private static final long serialVersionUID = -6918711902569942487L;


	public NEDMUSP0040VO () {}
	
	//crud파람
	private List<NEDMUSP0040VO> updateParam;
	...
	public List<NEDMUSP0040VO> getUpdateParam() {
		return updateParam;
	}

	public void setUpdateParam(List<NEDMUSP0040VO> updateParam) {
	...
	public String getSearchSrcmkVal() {
		return searchSrcmkVal;
	}

	public void setSearchSrcmkVal(String searchSrcmkVal) {
		this.searchSrcmkVal = searchSrcmkVal;
	}

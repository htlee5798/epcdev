...
public class NEDMPAY0050VO implements Serializable {

	
	private static final long serialVersionUID = -6918711902569942487L;


	public NEDMPAY0050VO () {}
	...
	private String subMm;
    private String strNm; 
    private String strSplyAmt; 
	...
	public String getSubMm() {
		return subMm;
	}
	public void setSubMm(String subMm) {
		this.subMm = subMm;
	}
	public String getStrSplyAmt() {
		return strSplyAmt;
	}
	public void setStrSplyAmt(String strSplyAmt) {
		this.strSplyAmt = strSplyAmt;
	}

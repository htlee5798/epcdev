...
public class NEDMPRO0222VO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2737498411312442061L;


	public NEDMPRO0222VO() {}
	...
	private String variant    	  ; 	// PGM ID  (KEY)
	...
	private String wUseFg	      ;		// vic 사용여부
	private String wInnerIpsu	  ;		// vic 박스수 
	
	private String newProdId	  ;    //임시보관함 new_prod_id
	...
	public String toString(){
		...
		vo +="\n venCd" + this.venCd	              ;
		vo +="\n l1Cd" + this.l1Cd	                  ;
		vo +="\n srcmkCd" + this.srcmkCd	          ;
		vo +="\n prodCd" + this.prodCd		          ;
		vo +="\n pgmId" + this.pgmId    	          ;
		vo +="\n seq" + this.seq	                  ;
		vo +="\n logiBcd" + this.logiBcd	          ;
		vo +="\n logiCfmFg" + this.logiCfmFg	      ;
		vo +="\n useFg" + this.useFg	              ;
		vo +="\n mixProdFg" + this.mixProdFg	      ;
		vo +="\n wg" + this.wg	                      ;
		vo +="\n width" + this.width	              ;
		vo +="\n length" + this.length	              ;
		vo +="\n height" + this.height	              ;
		vo +="\n conveyFg" + this.conveyFg	          ;
		vo +="\n sorterFg" + this.sorterFg	          ;
		vo +="\n innerIpsu" + this.innerIpsu	      ;
		vo +="\n pltLayerQty" + this.pltLayerQty     ;
		vo +="\n pltHeightQty" + this.pltHeightQty   ;
		vo +="\n logiBoxIpsu" + this.logiBoxIpsu     ;
		vo +="\n chgFg" + this.chgFg                 ;
		vo +="\n crsdkFg" + this.crsdkFg             ;
		vo +="\n regDt" + this.regDt		          ;
		vo +="\n wUseFg" + this.wUseFg	              ;
		vo +="\n wInnerIpsu" + this.wInnerIpsu	      ;
		vo +="\n newProdId" + this.newProdId	      ;
		return vo;
	}

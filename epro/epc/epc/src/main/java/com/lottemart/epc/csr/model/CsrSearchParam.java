...
public class CsrSearchParam implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8683728625117362182L;

	
	private String sEmpNo;
	private String sDyReg;
	...
	public String getsDyReg() {
		return sDyReg;
	}
	public void setsDyReg(String sDyReg) {
		this.sDyReg = sDyReg;
	}

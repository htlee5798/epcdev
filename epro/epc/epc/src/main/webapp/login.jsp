...
<head>
    ...
    <script type="text/javascript">
        ...
        function OnInit() {
            document.getElementById("txtPwd").addEventListener("keyup", function(e) {
...
<form id="form1" method="post" action="<%=url.getLoginFullUrl()%>">
    <input type="hidden" name="<%=SSOConst.CRED_TYPE%>" value="BASIC"/>
    <table>
        <tr>
            <td>사용자 ID :</td>
        ...
        <tr>
            <td colspan="2"><input type="button" value="로그온" onclick="OnLogon();"/></td>
        </tr>
    </table>
</form>
<hr/>

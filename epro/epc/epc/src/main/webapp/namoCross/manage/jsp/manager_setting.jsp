...
<title>Namo CrossEditor : Admin</title>
	<script type="text/javascript">var pe_oj="pe_vn"; </script>
			...
			<td class="pe_fm">
				...
				<table id="Info">
					<tr>
						...
						<font style="font-size:14pt;color:#3e77c1;font-weight:bold;text-decoration:none;"><span id="pe_tt"></span></font></td>
				...
				<table class="pe_fX">
					<tr>
						<td class="pe_XB">				
							<ul>
								<li class="pe_eq pe_vh"><input type="button" id="setting_base" value="" style="width:110px;height:28px;" class="pe_mU pe_cK" /></li>
								<li class="pe_eq"><input type="button" id="setting_edit" value="" style="width:110px;height:28px;" class="pe_mU pe_cK" /></li>
								<li class="pe_eq"><input type="button" id="setting_view" value="" style="width:110px;height:28px;" class="pe_mU pe_cK" /></li>
								<li class="pe_eq"><input type="button" id="setting_ab" value="" style="width:110px;height:28px;" class="pe_mU pe_cK" /></li>
							</ul>
						
						</td>
					</tr>
					<tr>
						<td class="pe_gA pe_eK"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_xC"></span></font></td>
					</tr>
				</table>
			...
			<td class="pe_fm">
				<div id="pe_Di">
					<table class="pe_na">
						<tr>
							<td>
								<table class="pe_bP"><tr><td class="pe_cs" colspan="3"></td></tr>
								</table>
							 
								<table class="pe_bP">
								
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_tZ"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_vA"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_tU"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_tp"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
											<input type="text" id="ImageSavePath" class="pe_gW" name="ImageSavePath" value="<%=settingValue.get("ImageSavePath")%>" /> ex) http:// www.mysite.com/image
										</td>
									</tr>
									...
									<div id="pe_Io">
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wX"></span></b></td>
										<td class="pe_bD"></td>
										<td >
											<table class="pe_bP">
												<tr>
													<td class="pe_bO"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_yo" value="real" /><span id="pe_wq"></span>
												...
												<tr>
													<td class="pe_bO"> &nbsp;&nbsp;
													<input type="radio" name="encodingStyle" id="pe_Bt" value="trans" /><span id="pe_wG"></span>
													</td>
												</tr>
												<tr>
													<td class = "pe_bs" colspan="3"></td>
												...
												<tr>
													<td class="pe_bO"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_zN" value="random" /><span id="pe_zF"></span>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_yw"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO"> &nbsp;
											<input type="hidden" id="UploadFileSubDir" name ="UploadFileSubDir" value="<%=settingValue.get("UploadFileSubDir")%>" />
											<input type="radio" id="pe_uM" name="pe_za" value="true" /><label for="pe_uM"><span id="pe_ya"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_tF" name="pe_za" value="false" /><label for="pe_tF"><span id="pe_xR"></span></label>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_uX"></span></b></td>
										<td class="pe_bD"></td>
										<td >
											<table class="pe_bP">
												<tr>
													<td >&nbsp;&nbsp;<span id="pe_uG"></span></td>
													<td class="pe_bD"></td>
													<td class="pe_bO"><input type="text" id="Width" name="Width" class="pe_iu" maxlength="10" value="<%=settingValue.get("Width")%>" />
													px</td>
												</tr>
												<tr>
													<td class = "pe_bs" colspan="3"></td>
												...
												<tr>
													<td >&nbsp;&nbsp;<span id="pe_ud"></span></td>
													<td class="pe_bD"></td>
													<td class="pe_bO"><input type="text" id="Height" name="Height" class="pe_iu" maxlength="10" value="<%=settingValue.get("Height")%>" /> px
													</td>
												</tr>	
											</table>
										</td>
						...
						<tr>
							<td class="pe_gA pe_eK"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_wf"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_bP">
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_AJ"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_vr"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_AO"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_AB"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_yc"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wC"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_zz"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_zt"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_zS"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_uj"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
											<input type="text" id="DocBaseURL" name="DocBaseURL" class="pe_gW" value="<%=settingValue.get("DocBaseURL")%>" /> ex) http://www.mysite.com/doc.html 
										</td>
									</tr>
						...
						<tr>
							<td class="pe_gA pe_eK"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_xW"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_bP">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="AdminPageUploadFileExtBlockList"><span id="pe_qY"></span></b></td>
										<td class="pe_bD"></td>
										<td>
											<table class="pe_bP">
												<input type="hidden" name="UploadImageFileExtBlockList" value="<%=settingValue.get("UploadImageFileExtBlockList")%>" />
												<tr>
													<td class="pe_bO"><input type="checkbox" id="UploadImageFileExtBlockListChecked" <%=settingValue.get("UploadImageFileExtBlockListChecked")%>/><span id="pe_kg"></span></td>
												</tr>
												<tr>
													<td class="pe_bO"><textarea id="UploadImageFileExtBlockListTextarea" cols="70" rows="2"><%=settingValue.get("UploadImageFileExtBlockListTextarea")%></textarea><br /><span id="pe_uN"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="AdminPageUploadFileExtBlockList"></span></b></td>
										<td class="pe_bD"></td>
										<td>
											<table class="pe_bP">
												<input type="hidden" name="UploadFileExtBlockList" value="<%=settingValue.get("UploadFileExtBlockList")%>" />
												<tr>
													<td class="pe_bO"><input type="checkbox" id="UploadFileExtBlockListChecked" <%=settingValue.get("UploadFileExtBlockListChecked")%>/><span id="pe_kg"></span></td>
												</tr>
												<tr>
													<td class="pe_bO"><textarea id="UploadFileExtBlockListTextarea" cols="70" rows="2"><%=settingValue.get("UploadFileExtBlockListTextarea")%></textarea><br /><span id="pe_uN"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Av"></span></b></td>
										<td class="pe_bD"></td>
										<td >
											<table class="pe_bP">
												<input type="hidden" name="AttributeBlockList" value="<%=settingValue.get("AttributeBlockList")%>" />
												<tr>
													<td class="pe_bO"><input type="checkbox" id="AttributeBlockListChecked" <%=settingValue.get("AttributeBlockListChecked")%>/><span id="pe_kg"></span></td>
												</tr>
												<tr>
													<td class="pe_bO"><textarea id="AttributeBlockListTextarea" cols="70" rows="2"><%=settingValue.get("AttributeBlockListTextarea") %></textarea><br /><span id="pe_nO"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_ye"></span></b></td>
										<td class="pe_bD"></td>
										<td >
											<table class="pe_bP">
												<input type="hidden" name="TagBlockList" value="<%=settingValue.get("TagBlockList")%>" />
												<tr>
													<td class="pe_bO"><input type="checkbox" id="TagBlockListChecked" <%=settingValue.get("TagBlockListChecked")%>/><span id="pe_kg"></span></td>
												</tr>
												<tr>
													<td class="pe_bO"><textarea id="TagBlockListTextarea" cols="70" rows="2"><%=settingValue.get("TagBlockListTextarea") %></textarea><br /><span id="pe_nO"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
						...
						<tr>
							<td class="pe_gA pe_eK"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_xS"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_bP" >
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_yg"></span></b></td>
										<td class="pe_bD"></td>
										<td>
											<table class="pe_bP">
												<input type="hidden" name="Template" id="Template" value="<%=settingValue.get("Template")%>" />
												<tr>
													<td class="pe_bO"><input type="button" id="pe_aiy" value="+" onClick="pe_H(this)"/></td>
													<td class="pe_bO">&nbsp;</td>
													<td class="pe_bO">&nbsp;</td>
												</tr>
												<tr style="background-color:#B2EBF4;">
													<td class="pe_bO"><b>Title</b></td>
													<td class="pe_bO"><b>URL</b></td>
													<td class="pe_bO"><b>Encoding</b></td>
												</tr>
											...
											for(int i=0; i<TemplateListArr.length ; i++){
												...
												if(TemplateListArr[i] == null || TemplateListArr[i] == ""){
													...
													%>
														<tr>
															<td><input type="text"  name="pe_By"  value="<%=templateName %>" style="width:100px"/></td>
															<td><input type="text"  name="pe_JA"  value="<%=templateUrl %>" style="width:320px"/></td>
															<td><input type="text"  name="pe_Jc"  value="<%=templateEncoding %>" style="width:90px"/><input type="button" value="-" onclick="pe_M(this)"/></td>
					...
					<table class="pe_na">
						<tr>
							<td>
								...
								<table class="pe_bP">
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xO"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_FL" class="color{hash:true,valueElement:'FontColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="FontColor" name="FontColor" value="<%=settingValue.get("FontColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_eZ">
											<input type="button" class="pe_eA pe_cK" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_FL').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xN"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wV"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xk"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										...
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_zB"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO"><input type="checkbox" id="ReturnKeyActionBRChecked" <%=settingValue.get("ReturnKeyActionBRChecked")%>/><label for="ReturnKeyActionBR"><span id="pe_zK"></span></label></td>
									</tr>
									<tr>
										<td class="pe_bs" colspan="3"></td>
									</tr>
								...
								<table class="pe_bP">
									<tr>
										<td class="pe_gA pe_eK"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_qY"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xl"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_CC" class="color{hash:true,valueElement:'ImgLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="ImgLineColor" name="ImgLineColor" value="<%=settingValue.get("ImgLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_eZ">
											<input type="button" class="pe_eA pe_cK" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_CC').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
								...
								<table class="pe_bP">				
									<tr>
										<td class="pe_gA pe_eK"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_zp"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_zm"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_Gg" class="color{hash:true,valueElement:'TableLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="TableLineColor" name="TableLineColor" value="<%=settingValue.get("TableLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_eZ">
											<input type="button" class="pe_eA pe_cK" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_Gg').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_zY"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
											<table>
											<tr>
											...
											<ul style="width:140px;">
											<li class="pe_eZ">
											<input type="button" class="pe_eA pe_cK" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_CZ').color.fromString('#FFFFFF');">
											</li>
											</ul></td>
											</tr>
											</table>
					...
					<table class="pe_na">
						<tr>
							<td>
								...
								<table class="pe_bP">
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_zo"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_De"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wP"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
											<input type="text" id="Css" name="Css" class="pe_gW" value="<%=settingValue.get("Css")%>" />  ex) http://www.mysite.com/common.css 
										</td>
									</tr>
									<tr>
										<td class="pe_bs" colspan="3"></td>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_zx"></span></b>
										...
										<td >
											<table class="pe_bP">
												<tr>
													<td class="pe_nq">&nbsp;&nbsp;<span id="pe_AM"></span></td>
													<td class="pe_bD"></td>
													<td class="pe_bO">
														<input type="text" id="outlinecolor" name="outlinecolor" class="pe_mY" value="" />  ex) #000000 or black 
													</td>
												</tr>
												<tr>
													<td class="pe_bs" colspan="3"></td>
												...
												<tr>
													<td class="pe_nq">&nbsp;&nbsp;<span id="pe_xQ"></span></td>
													<td class="pe_bD"></td>
													<td class="pe_bO">
														<input type="text" id="innerlineColor" name="innerlineColor" class="pe_mY" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_bs" colspan="3"></td>
												...
												<tr>
													<td class="pe_nq">&nbsp;&nbsp;<span id="pe_wa"></span></td>
													<td class="pe_bD"></td>
													<td class="pe_bO">
														<input type="text" id="skinfontColor" name="skinfontColor" class="pe_mY" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_bs" colspan="3"></td>
												...
												<tr>
													<td class="pe_nq">&nbsp;&nbsp;<span id="pe_yb"></span></td>
													<td class="pe_bD"></td>
													<td class="pe_bO">
														<input type="text" id="toolbarBackgroundColor" name="toolbarBackgroundColor" class="pe_mY" value="" />
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_zQ"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
											<input type="hidden" id="CreateTab" name ="CreateTab" value="<%=settingValue.get("CreateTab")%>" />
											<input type="checkbox" id="pe_tl" name="pe_mV" value="0" /><label for="pe_tl"><span id="wysiwyg"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_qe" name="pe_mV" value="1" /><label for="pe_qe"><span id="html"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_rQ" name="pe_mV" value="2" /><label for="pe_rQ"><span id="preview"></span></label>
										</td>
									</tr>
								</table>
						...
						<tr>
							<td class="pe_gA pe_eK"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_xy"></span></font></td>
						</tr>
						<tr>
							<td>
								<table class="pe_bP"><tr><td class="pe_cs" colspan="3"></td></tr>
								...
								<table class="pe_bP">
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wO"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
							...
							<tr>
								<td>
									<table class="pe_bP">
										...
										<tr>
											<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_yx"></span></b></td>
											<td class="pe_bD"></td>
											<td>
												<table class="pe_bP">
													<tr>
														<td class="pe_ml" >&nbsp;&nbsp;<span id="pe_yY"></span></td>
														<td class="pe_bD"></td>
														<td class="pe_bO">
															<input type="text" id="AdminPageUserMenuIdInput" name="AdminPageUserMenuIdInput" class="pe_gW" value="" /> 
														</td>
													</tr>
													<tr>
														<td class="pe_bs" colspan="3"></td>
													...
													<tr>
														<td class="pe_ml">&nbsp;&nbsp;<span id="pe_zc"></span></td>
														<td class="pe_bD"></td>
														<td class="pe_bO">
															<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_tV" value="function" /><label for="pe_tV"><span id="pe_xM"></span></label>&nbsp;&nbsp;<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_tW" value="plugin" /><label for="pe_tW"><span id="pe_Ak"></span></label>
														</td>
													</tr>
													<tr>
														<td class="pe_bs" colspan="3"></td>
													...
													<tr>
														<td class="pe_ml">&nbsp;&nbsp;<span id="pe_AN"></span></td>
														<td class="pe_bD"></td>
														<td class="pe_bO" height="50px">
															<input type="text" id="AdminPageUserMenuButtonImgPathInput" name="AdminPageUserMenuButtonImgPathInput" class="pe_gW" value="" />
													...
													<tr>
														<td class="pe_ml">&nbsp;&nbsp;<span id="pe_zr"></span></td>
														<td class="pe_bD"></td>
														<td class="pe_bO">	
															<input type="text" id="AdminPageUserMenuTitleInput" name="AdminPageUserMenuTitleInput" class="pe_gW" value="" />
														</td>
													</tr>
												</table>
											</td>
											<td class="pe_bD"></td>
											<td style="text-align:center;vertical-align:middle;"><input type="button" id="pe_tY" value="" class="" style="width:60px;height:60px;"/>
											</td>
										</tr>
										<tr>
											<td class="pe_bs" colspan="5"></td>
										...
										<tr>
											<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_ze"></span></b></td>
											<td class="pe_bD"></td>
											<td class="pe_bO" colspan="2">
												<div id="pe_Ve">&nbsp;</div>
											</td>
										</tr>
										<tr>
									...
									<table>
										<tr>
											<td id="pe_aaO">
												...
												<div id="pe_Jt" >
													<span id="pe_qv"></span> <br> 
													<span id="pe_vm"></span><br>
											...
											<td valign="bottom">
												<ul style="margin:0 auto;width:340px;">
													<li class="pe_eZ">
														<input type="button" id="spacebar" value="" class="pe_eA pe_cK" style="width:80px;height:26px;" />
													</li>
													<li class="pe_eZ"><input type="button" id="space" value="" class="pe_eA pe_cK" style="width:68px;height:26px;"></li>
													<li class="pe_eZ"><input type="button" id="enter" value="" class="pe_eA pe_cK" style="width:66px;height:26px;"></li>
												</ul>
											</td>
										</tr>
										<tr>
					...
					<table class="pe_na">
						<tr>
							<td>
								...
								<table class="pe_bP">
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_yN"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
											<input type="text" id="DocTitle" name="DocTitle" class="pe_gW" value="<%=settingValue.get("DocTitle")%>" />
										</td>
									</tr>
									<tr>
										<td class="pe_bs" colspan="3"></td>
									...
									<tr>
										<td class="pe_bw">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wd"></span></b></td>
										<td class="pe_bD"></td>
										<td class="pe_bO">
											<input type="hidden" id="AccessibilityOption" name ="AccessibilityOption" value="<%=settingValue.get("AccessibilityOption")%>" />
											<input type="radio" id="pe_wk" name="pe_pC" value="0" /><label for="pe_wk"><span id="pe_zV"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_vP" name="pe_pC" value="1" /><label for="pe_vP"><span id="pe_AS"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_wH" name="pe_pC" value="2" /><label for="pe_wH"><span id="pe_Ad"></span></label>
										</td>
									</tr>
									<tr>
										<td class="pe_bs" colspan="3"></td>

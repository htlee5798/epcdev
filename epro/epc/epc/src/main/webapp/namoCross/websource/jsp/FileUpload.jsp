...
<%
	...
	if ( detectXSSEx(request.getParameter("fileDomain")) != null)
		fileDomain =  detectXSSEx(request.getParameter("fileDomain")).replaceAll("[\\r\\n]", "");
/*
...
*/
	...
	if (!fileRealFolderWriteCheck.canWrite()) {
		scriptValue = executeFileScript(response, "canWriteErr", imagePhysicalPath, useExternalServer, fileDomain, fileEditorFlag, checkPlugin);
		response.getWriter().println(scriptValue);
		return;
	}

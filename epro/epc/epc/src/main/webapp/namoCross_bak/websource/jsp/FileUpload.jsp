...
<%
	...
	*/
	...
	String defaultUPath = SecureUtil.splittingFilter(detectXSSEx(request.getParameter("defaultUPath")));
	String imageUPath = SecureUtil.splittingFilter(detectXSSEx(request.getParameter("fileUPath")));
	...
	if (imagePhysicalPath.equals("")) {
		...
		if (DompaserValue.equals("")) {
			...
			if(imagePhysicalPath == null && imageUPath != null && ContextPath != null){
				imagePhysicalPath = SecureUtil.splittingFilter(context.getRealPath(imageUPath.substring(ContextPath.length())));
			}

...
$(document).ready(function() {
	...
	ibdata.Cols = [
	  ...
	  , {Header:"상세설명", 				Type:"Text", 		SaveName:"PROD_DESC",  		Align:"Center",		Width:70,	Edit:0,	Cursor:'pointer', FontUnderline:true}
...
function goPage(currentPage) {
	var url = '<c:url value="/product/selectProdKeywordChgHist.do"/>';
...
function viewDesc(seq,prodCd) {
	var targetUrl = '<c:url value="/product/keywordChgDetailForm.do"/>?seq='+seq+'&prodCd='+prodCd;

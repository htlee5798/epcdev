      ...
      <form name="searchForm" id="searchForm" method="post" action="#">
        ...
        <div id="wrap_menu">
          ...
          <div id="divFrame" style="border: 1px solid #d3d3d3; margin-top: 10px;">
            <iframe id="frameManageAttrInfo" style="width: 100%; height: 160px;" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no vspace=0></iframe>
          </div>
          ...
          <div class="wrap_con">
            <div class="bbs_list">
              ...
              <div style="width: 100%; height: 320px; overflow-x: hidden; overflow-y: scroll; overflow-x: scroll; table-layout: fixed;">
  ...
  const pf = (function pageFunction() {
    return {
      goToModifyGrpAttr: function(idx) {
        ...
        const url = '<c:url value="/edi/product/NEDMPRO0091.do"/>';
        ...
        fetchProdAttrInfo: function(pageIdx) {      
          ...
          function _createTbodyDom(prodAttrInfo, idx) {
            return '<tr class="r1"  bgcolor="ffffff">' 
                 ...
                 + '<td align="center"> '+ prodAttrInfo.CNT_ATT_ID_SAVED + ' / ' + prodAttrInfo.CNT_ATT_ID + '</td>' 
                 + '</tr>';
          }
          // 상품 분석속성 DOM 생성
          ...
          function _callBackFetchProdAttrInfo(prodAttrInfoJson) {
            let _prodAttrInfo = prodAttrInfoJson.grpAttrInfoList;
          ...
          function _fetchProdAttrInfo(pageIdx) {
            const _url = '<c:url value="/edi/product/getGrpAttr.json"/>';
            const _ajaxOpt = {
              method: "POST",
              headers: {

...
// 			}
			...
			var srchTitle = "<CAPTION>신상품등록현황<br>";
				...
				srchTitle += "[상품 상태: "+productStatus+"]<br>";
...
--%>
			<td class="prodNm">
				<a href="javascript:_eventViewProductInfo('<c:out value="\${pgmId}"/>', '<c:out value="\${onOffDivnCd}"/>',	'<c:out value="\${cfmFg}"/>','<c:out value="\${prodTypeFlag}"/>')" 
					class="tooltip" data-tooltip-content="#tt_\${pgmId}">
					<c:out value="\${prodNm}"/>
				</a>
						...
						<div class="bbs_search">
							...
							<table class="bbs_search" cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									...
									<th>상품구분</th>
									<td>
										<html:codeTag objId="srchProdDivnCd" objName="srchProdDivnCd" width="150px;"  dataType="TCPCD" parentCode="PATFG" comType="SELECT" formName="form" defName="전체" />
					...
					<div class="wrap_con">
						<div class="bbs_list">
							...
							<div style="width:100%; height:458px;overflow-x:hidden; overflow-y:scroll; overflow-x:scroll;  table-layout:fixed;white-space:nowrap;">
								<table id="dataTable" cellpadding="1" cellspacing="1" border="0" width=2480px; bgcolor=efefef>
									<colgroup>
...
<!-- 										<col style="width:70px"/> -->
									...
									<tr bgcolor="#e4e4e4">
										...
										<th rowspan="3">협력업체</th>
										<th rowspan="3">상태</th>
										<th rowspan="3">거절&반려 사유</th>
										<th rowspan="3">이미지</th>
										<th rowspan="3">물류바코드</th>
<!-- 										<th>VIC대상</th> -->
										<th rowspan="3">상품명</th>
										<th rowspan="3">판매코드</th>
										<th rowspan="3">상품코드</th>
										<th rowspan="3">속성</th>
										<th rowspan="3">상품규격</th>
										<th rowspan="3">입수</th>

...
<%
	  response.setHeader("Content-Disposition", "attachment;filename=PSCMDLV000901.xls;") ;
			...
			<div class="wrap_con">
				...
				<div class="bbs_list">
					...
					<tr>
						...
						<th bgcolor="cccccc">총결제금액</th>
						<th bgcolor="cccccc">사유</th>
						<th bgcolor="cccccc">접수일자</th>
					</tr>					
	<c:choose>		
		<c:when test="${list != null}">		
			<c:forEach var="result" items="${list}">
					<tr>
						...
						<td align="right"><fmt:formatNumber value="${result.TOT_QTY}" pattern="#,##0" /></td>
						...
						<td align="right"><fmt:formatNumber value="${result.SUM_TOT_SELL_AMT}" pattern="#,##0" /></td>

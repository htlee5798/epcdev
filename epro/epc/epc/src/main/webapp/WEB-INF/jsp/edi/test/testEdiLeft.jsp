...
<!-- 2012.07.18 임재유 - 조충환K 요청으로 삭제 -->
						...
						<li id="s1" class="depth2 plus"><a href="#"
							...
							<ul id="smenu1" style="display: none;">
								...
								<li><a href='<c:url value="/edi/product/NEDMPRO0063.do"/>'
									target="contentFram"><font color="red">EC 카테고리조회</font></a></li>
								<li><a href='<c:url value="/edi/product/NEDMPRO0064.do"/>'
									target="contentFram"><font color="red">EC 카테고리별 속성 조회</font></a></li>
						...
						<li id="s2" class="depth2 plus"><a href="#"
							...
							<ul id="smenu2" style="display: none;">
								...
								<li><a href='<c:url value="/edi/product/NEDMPRO0130.do"/>'
									target="contentFram">이미지사이즈 관리</a></li>
								...
								<li><a href='<c:url value="/edi/product/NEDMPRO0170.do"/>'
									target="contentFram">상품단종 신청</a></li>
				...
				<c:when test="${pgm.pgm_code eq 'TST'}">
					<h2>TEST</h2>
					<ul>
						<li id="s1" class="depth2 plus"><a href="#"
							onclick="menuclick(1,'N');" class="d2">TEST정보1</a>
							<ul id="smenu1" style="display: none;">
								<li><a href="<c:url value="/edi/test/NEDMTST0010.do"/>"
									target="contentFram">테스트페이지</a></li>
							</ul>
						</li>
						<li id="s2" class="depth2 plus"><a href="#"
							onclick="menuclick(2,'N');" class="d2">TEST정보2</a>
							<ul id="smenu2" style="display: none;">
								<li><a href="<c:url value="/edi/buy/NEDMBUY0120.do"/>"
									target="contentFram">센터입고거부</a></li>
							</ul>
						</li>
					</ul>
				</c:when>

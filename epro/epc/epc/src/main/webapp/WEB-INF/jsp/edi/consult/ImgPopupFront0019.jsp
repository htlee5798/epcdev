...
<script>
	...
	function closeWin(cookiename)  {
	    setCookieToday(cookiename, 'popcookie20200306' , 1);        
	    top.close();
	}
	...
	<tr>
		<td bgcolor=ffffff>
			<table cellspacing=0 cellpadding=0 border=0 width=100%>
				<TR>
				 	<img alt="" src="/images/epc/popup/corona.jpg" width="680" height="787">
				</td>			
			</TR>
			<TR>
			<td>
				<input type="checkbox" id="user_chk" name="user_chk" value="" onclick="closeWin('popcookie20200306');"> 이 메세지를 더이상 표시하지 않음.
			</td>
			</TR>
			</table>
			</td>

...
function insert(){
	...
	var addUrl = '<c:url value="/etc/insertCodePopup.do"/>';
	 ...
	 <!--  @process  //-->
		...
		<div class="bbs_search3">
			...
			<tr>
				...
				<td><input type="text" name="majorCd" value="" /></td>
				<th class="fst">MINOR코드</th>
				<td class="left"><input type="text" name="minorCd" value="" /></td>
			</tr>
			<tr>
				<th class="fst">코드명</th>
				<td><input type="text" name="cdNm" value="" /></td>
				<th class="fst">설명</th>
				<td class="left"><input type="text" name="cdDesc" value="" /></td>
			</tr>
			</table>
		</div>
		<!--  @작성양식  2//-->

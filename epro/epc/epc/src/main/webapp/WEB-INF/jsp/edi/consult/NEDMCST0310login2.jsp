...
<script language="JavaScript">
	...
	function confirm_submit()
	{
		...
		if($.trim( $("#MyForm  #password").val() ) == "" ){
			$("#MyForm  #password").focus();
			strMsg ="<spring:message code='msg.consult.require.passCheck'/>"; /*  비밀번호를 입력하세요 */
			alert(strMsg);
			return false;
		}
...
<body>
	...
	<form name="MyForm"  id="MyForm" method="post"  action="<c:url value='/epc/edi/consult/NEDMCST0310checkVendorBusinessNo2.do'/>">

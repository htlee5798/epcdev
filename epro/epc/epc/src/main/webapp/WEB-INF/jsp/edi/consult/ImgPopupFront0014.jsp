...
<script>
	...
	function closeWin(cookiename)  {
	    setCookieToday(cookiename, 'popcookie20161229' , 1);        
	    top.close();
	}
	...
	<tr>
		<td bgcolor=ffffff>
			<table cellspacing=0 cellpadding=0 border=0 width=100%>
				<TR>
				 	<img alt="" src="/images/epc/popup/20161229popUp.png" width="900" height="720">
				</td>			
			</TR>
			<TR>
			<td>
				<input type="checkbox" id="user_chk" name="user_chk" value="" onclick="closeWin('popcookie20161229');"> 이 메세지를 더이상 표시하지 않음.
			</td>
			</TR>
			</table>
			</td>

				...
				<div class="bbs_list">
					...
					<tr class="r1">
						<td>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;<div class="con_title">
								<h1><a href='<c:url value="/edi/consult/NEDMCST0011.do"/>'><img src="/images/epc/edi/consult/collaboration_a_2_re.gif" ></a></h1>
							</div><br>
							&nbsp;&nbsp;&nbsp;&nbsp;<div class="con_title">
								<h1><a href='<c:url value="/edi/consult/NEDMCST0012.do"/>'><img src="/images/epc/edi/consult/netloan_fnq_n.gif" ></a></h1>
							</div><br><br>

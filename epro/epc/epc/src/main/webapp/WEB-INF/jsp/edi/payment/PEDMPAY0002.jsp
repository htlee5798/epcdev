...
<script>
	...
	function popupSearch(tbName1, tbName2, tbName3){		
		...
		form.staticTableBodyValue.value = "<CAPTION>결산정보 대금결제정보 현황표<br>"+
		"[조회기간 : "+date+"] [업체 : "+tmp+"]<br>"+
	...
	function printText(){
		...
		form.action  = "<c:url value='/edi/payment/PEDMPAY0002Text.do'/>";
		form.submit();	
		...
		<div id="wrap_menu">
			...
			<div class="wrap_con">
				...
				<div class="bbs_list">
					...
					<tr>
						<th rowspan="3">대금지급일</th>
						<th rowspan="3">지급대상액</th>
						<th colspan="4">공제내역</th>
						<th rowspan="3">네트워크론<br>지급</th>
					...
					<c:if test="${not empty paymentList }">
						<tr class="r1">
							<th rowspan="2" align="center"><b>합계</b></th>
					...
					<c:if test="${empty paymentList }">
						<tr><td colspan=8>&nbsp;</td><th rowspan=2 width=17>&nbsp;</th></tr>

...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		ibdata.Cols = [
		  ...
		  , {Header:"주문금액",     		Type:"Int", 				SaveName:"ORDER_ITEM_AMT_SUM", 	Align:"Right", 	  Width:100, Edit:0, Format:"#,###,###"}
		  , {Header:"주문원가",        	Type:"Int", 				SaveName:"BUY_PRC", 						Align:"Right", 	  Width:100, Edit:0, Format:"#,###,###"}
		  , {Header:"할인금액", 			Type:"Int", 				SaveName:"DC_AMT_SUM", 	      		Align:"Right", 	  Width:80, Edit:0, Format:"#,###,###"}
		  , {Header:"배송료", 	    		Type:"Int", 				SaveName:"DELIVERY_AMT_SUM", 	    Align:"Right", 	  Width:110, Edit:0, Format:"#,###,###"}
		  , {Header:"결제금액", 			Type:"Int", 				SaveName:"APPLY_TOT_AMT", 	      	Align:"Right", 	  Width:100, Edit:0, Format:"#,###,###"}
		  , {Header:"결제방법", 	    	Type:"Text", 			SaveName:"SETL_TYPE_NM", 	      		Align:"Center", Width:100, Edit:0}
		  , {Header:"포인트결제", 		Type:"Int", 				SaveName:"APPLY_OCUR_POINT", 	    Align:"Right", 	  Width:80, Edit:0, Hidden:true}
		  , {Header:"쿠폰결제", 	    	Type:"Int", 				SaveName:"APPLY_COUPON_AMT", 	Align:"Right", 	  Width:80, Edit:0, Hidden:true}
    ...
    {
        var url = '<c:url value="/order/selectSocialOrderList.do"/>';
...
if(confirm('엑셀 다운로드 하시겠습니까?')){
			...
			$.ajax({
				...
				dataType : 'json',
				async : false,
				url : '<c:url value="/order/selectCustInfo.json"/>',
				data : JSON.stringify(paramInfo),
				success : function(data) {					
					var resultList	=	data.excelPossYn;
					$("#CustInfo").val(resultList);
				}
			});		
			...
			if(parseInt($("#CustInfoByGoods").val()) > 0){
				...
				directExcelDown(mySheet, '소셜주문목록조회_' + new Date().yyyymmdd(), xlsUrl, '#searchForm', param, hideCols); // 전체 다운로드
			}
		}
						...
						<div class="bbs_search">
							...
							<table class="bbs_search" cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									...
									<th>원주문번호</th>
									<td><input type="text" id="orderId" name="orderId" value="" class="input" maxlength="12"/></td>
									<th>협력업체코드</th>
									<td>
										<c:choose>
											<c:when test="${epcLoginVO.vendorTypeCd eq '06'}">
					...
					<div class="wrap_con">
						...
						<div class="bbs_list">
							...
							<table class="bbs_list" cellpadding="0" cellspacing="0"
								border="0">
								<tr>
<!-- 									<td><script type="text/javascript">initWiseGrid("WG1", "100%", "335");</script></td> -->

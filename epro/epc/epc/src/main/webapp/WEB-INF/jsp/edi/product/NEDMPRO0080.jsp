  ...
  const pf = (function pageFunction() {
    return {
      showAttrAprvInfoWindow: function(aprvStat, prodCd, l3Cd) {
        ...
        const url = '<c:url value="/edi/product/NEDMPRO008001.do"/>' + "?" + urlParam;
        const windowStatus = 'height=320, width=450, top=50, left=50, location, resizable';

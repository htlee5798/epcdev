...
<script language="JavaScript">
	...
	function confirm_submit() {
		...
		if (document.MyForm.password.value.length == 0) {
			...
			//popUrl = "pop_message_00.asp?strMsg=" + strMsg + "&objFocus=MyForm.pwd"
			//openPopup2(popUrl,'ID');   
		...
		var busienssNo = $("#Text1").val() + $("#Text2").val()
				+ $("#Text3").val();
	...
	function checkbman_no3(obj1, obj2, obj3) {
		...
		if (strLeng(obj1.value) == 3 && strLeng(obj2.value) == 2
				&& strLeng(obj3.value) == 5) {
			if ((isInteger(obj1.value)) && (isInteger(obj2.value))
					&& (isInteger(obj3.value))) {
	...
	function FindPwd() {
		...
		window
				.open(popurl, null,
						"height=390,width=500,status=no,toolbar=no,menubar=no,location=no");
	}
	...
	function openPopup(openUrl, popTitle, WindowWidth, WindowHeight) {
		...
		NewWin = window.open(openUrl, popTitle,
				"titlebar=no, resizable=1, width=" + WindowWidth + ", height="
						+ WindowHeight + ", top=" + WindowTop + ", left="
						+ WindowLeft);
		NewWin.focus();
	}
...
<body>
	...
	<form name="MyForm" method="post"
		action="${ctx }/epc/edi/consult/checkVendorBusinessNo2.do" ID="Form1">
		<input type="hidden" name="businessNo" /> <input type=hidden
			name=authBizNo value='' ID="Hidden1">
			...
			<div id="con_wrap">
				...
				<div class="con_area">
					...
					<div class="box_gray box_login">
						<p class="txt_btxt">
							<!-- 고객님의 -->
							<em>사업자번호</em>와 <em>비밀번호</em>를 입력해주세요.<br>
							...
							<div class="member_login">
								<dl class="input_info clearfloat">
									...
									<dd>
										...
										<span><input type="text" name="bman_no1"  maxlength="3" class="txt"  				  onKeyUp="next_BizNo2(this.value.length,document.MyForm.bman_no2, this);"  			style="width: 95px;" ID="Text1" ></span></span>
										 ...
										 - <span class="input_txt"><span><input type="text" name="bman_no3" maxlength="5"     onKeyUp="next_BizNo4(this.value.length,document.MyForm.password, this)"	class="txt" style="width: 95px;" ID="Text3" ></span></span>
									</dd>
									...
									<dd class="end">
										<span class="input_txt"><span><input
												...
												ID="Password1" class="txt" style="width: 349px;"></span></span>
									</dd>

								</dl>
								<div class="btn_login">
								<!-- 	<img src="/images/epc/edi/consult/btn-login.gif"		onClick="confirm_submit();" style="cursor: hand;">
								 -->
						...
						<div class="pwd_find">
							비밀번호가 기억나지 않으세요? 비밀번호 찾기를 클릭하세요. <span class="btn_white btn_w_ls"><span><a
									href="javascript:FindPwd();"><spring:message
											code='button.common.findpwd' /></a></span></span>
						</div>
	...
	<script type="text/javascript" language="javascript"
		src="/js/front/front_input.js"></script>

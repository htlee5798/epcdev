...
<body>
	...
	<c:set var="urlPath" value="${pageContext.request.requestURL}"/>

	<!-- Wrap 메인인 경우만 .main_wrap 적용 -->
	<c:if test="${fn:indexOf(urlPath, 'SRMJONMain') > -1}">
		<div id="wrap" class="main_wrap">
	</c:if>
	
	<c:if test="${fn:indexOf(urlPath, 'SRMJONMain') < 0}">
		<div id="wrap">
	</c:if>
	
		<!-- Header -->
			<jsp:include page="/common/edi/srm/header.jsp"/>
		<!-- //Header -->
		...
		<!-- Footer -->
			<jsp:include page="/common/edi/srm/footer.jsp"/>
		<!-- //Footer -->

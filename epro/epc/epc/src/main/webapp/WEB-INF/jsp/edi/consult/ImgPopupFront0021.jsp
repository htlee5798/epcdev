...
<title>코로나19 관련 당부의 말씀</title>


<script>

	function closeWin(cookiename)  {
	    setCookieToday(cookiename, 'popcookie20200319' , 1);        
	    top.close();
	}
	...
	<tr>
		<td bgcolor=ffffff>
			<table cellspacing=0 cellpadding=0 border=0 width=100%>
				<TR>
				 	<img alt="" src="/images/epc/popup/partner202006.gif" width="560" height="540">
				</td>			
			</TR>
			<TR>
			<td>
				<input type="checkbox" id="user_chk" name="user_chk" value="" onclick="closeWin('popcookie20200319');"> 이 메세지를 더이상 표시하지 않음.
			</td>
			</TR>
			</table>
			</td>

...
function goPage(pageIndex){
	...
	var url = '<c:url value="/statistics/selectKtShopList.do"/>';
...
function doExcel(){
	...
	var url = '<c:url value="/statistics/selectKsShopListExcel.do"/>';
	f.pageIndex.value = 1;
	f.action = url;
	f.submit();	
}

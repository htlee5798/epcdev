...
<%
	  response.setHeader("Content-Disposition", "attachment;filename=PSCMSTA000801.xls;") ;
	...
	<div class="content_scroll">
		...
		<div id="wrap_menu">
			...
			<c:choose>
				...
				<c:otherwise>
					<tr class="r1">
						<td class="fst" colspan="7" style="text-align: center;"><spring:message code="msg.common.info.nodata"/></td>
					</tr>
				</c:otherwise>
			</c:choose>

...
<script>
	...
	function closeWin(cookiename)  {
	    setCookieToday(cookiename, 'popcookie20140825' , 1);        
	    top.close();
	}
	...
	<tr>
		<td bgcolor=ffffff>
			<table cellspacing=0 cellpadding=0 border=0 width=100%>
				<TR>
					<td background="/images/epc/popup/movingwork_20150410.JPG"  WIDTH="550" HEIGHT="600">
				</td>			
			</TR>
			<TR>
			<td>
				<input type="checkbox" id="user_chk" name="user_chk" value="" onclick="closeWin('popcookie20140825');"> 이 메세지를 더이상 표시하지 않음.
			</td>
			</TR>
			</table>
			</td>

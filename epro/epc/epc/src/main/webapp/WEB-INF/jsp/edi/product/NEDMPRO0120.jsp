...
<script>
	...
	function eventSearch(){
		...
		$.ajax({
			...
			dataType : 'json',
			async : false,
			url : '<c:url value="/edi/product/selectStrProductListProxy.json"/>',
	...
	//DATA 후처리
	function _setDataList(json) {
		setTbodyInit("dataListbody");	// dataList 초기화
		
		var data = json.resultList;		// datalist
	...
	function fncExcelDownload(){
		...
		$("#searchForm").attr("target", "frameForDownload");
		$("#searchForm").attr("method", "POST");
		$("#searchForm").attr("action", '<c:url value="/edi/product/selectStrProductListProxyExcelDownload.do"/>');
		$("#searchForm").submit();
	}
</script>
				...
				<div class="wrap_search">
					...
					<div class="bbs_search">
						...
						<ul class="tit">
							...
							<li class="btn">
								<a href="#" class="btn" onclick="eventSearch();"><span><spring:message code="button.common.inquire"/></span></a>
								<a href="#" class="btn" onclick="fncExcelDownload();"><span><spring:message code="button.common.excel"/></span></a>
							</li>
						</ul>
						...
						<table class="bbs_search" cellpadding="0" cellspacing="0" border="0">
							...
							<input type="text" style="display:none;"/>	<%-- enterkey submit 방지용 --%>

...
<script language="javascript">
	...
	$(document).ready(function() {
		...
		$("input.imageUpload").change(function() {
			...
			/* 파일삭제 */
			if(!checkReturn){
				fileNm.replaceWith( fileNm.val('').clone(true)); // 잘못된 확장자 들어올경우 초기화
			}
				...
				<div class="con_area">
					...
					<div class="tb_form_comm">
						...
						<colgroup>
							...
							<td>
								<div class="td_p"  style="margin-left: 10px;">
...
-->
								...
								<tr>
									...
									<td>
										<div class="td_p">
											<span class="input_txt"><span>											
											<input type="text" class="txt" name="email1" id="email1" value="<c:out value='${vendor.email1}'/>" style="width: 90px;" onkeyup="javascript:cal_byte(this, '20', '<spring:message code="text.consult.field.email"/>');"></span></span> @ <span class="input_txt"><span>
					...
					<table cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<tr>
							...
							<th colspan="3" class="t_center num"><spring:message code='text.consult.header.imgAttachFile'/>
						...
						<th class="t_center num"></th>
							...
							<c:if test="${fn:length(vendorProductList) == 0 }">
								<tr>
									...
									<td class="t_center no_b_line" colspan="4">

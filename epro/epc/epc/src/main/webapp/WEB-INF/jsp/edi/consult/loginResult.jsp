...
<form name="MyForm" method="post"  action="${ctx }/epc/edi/consult/checkVendorBusinessNoResult.do" ID="Form1">
	...
	<div id="con_wrap">
		...
		<div class="con_area">
			...
			<div class="box_gray box_login">
				<p class="txt_btxt"><!-- 고객님의 --> <em>사업자번호</em>와 <em>비밀번호</em>를 입력해주세요.
				...
				<fieldset>
					...
					<div class="member_login">
						<dl class="input_info clearfloat">
							<dt>사업자번호</dt>
							<dd><span class="input_txt"><span>
							
							<input type="text" name="bman_no1"  maxlength="3" class="txt"  onKeyUp="next_BizNo2(this.value.length,document.MyForm.bman_no2, this)" style="width:95px;" ID="Text1"></span></span> 

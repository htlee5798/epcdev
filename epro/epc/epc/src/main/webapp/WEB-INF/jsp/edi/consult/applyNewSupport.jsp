...
<body>
<form name="MyForm" action="${ctx }/epc/edi/consult/insertApplyConfirmSupport.do" method="post" enctype="multipart/form-data" ID="Form1">
...
<div class="s_title">
					...
					<div class="tb_form_comm">
						...
						<td>
							<div class="td_p">
								<input class="chk" id="tSubteamCd1" type="radio" name="tSubteamCd" value="00022" <c:if test="${vendor.tSubteamCd eq 00088}"> checked </c:if> <c:if test="${empty vendor.bmanKindCd}"> checked </c:if>  ><label class="label mr20" for="business1">총무구매팀</label>
						   </div>
						</td>									
					...
					<tr>
						...
						<td><div class="td_p"><span class="input_txt"><span><input maxlength="15"  type="text" name="ceoNm" class="txt" value="${vendor.ceoNm}" style="width:232px;" onkeyup="javascript:cal_byte(this, '50', '대표자명');"></span></span></div>
						</td>
					</tr>
					<tr>
			...
			<div class="tb_form_comm">
				...
				<tbody>
					...
					<tr>					
						...
						<th><p class="check">주력품목<br>(생산품)</p></th>
						<td>
							<p class="td_p">
								<span class="input_txt"><span><input type="text" name="mainProduct" class="txt" value="${vendor.mainProduct }"  maxlength="20" style="width:156px;"></span></span>
							</p>
						</td>
						<th ><p class="check">연매출액<br>(전년기준)</p></th>
						<td >
							<p class="td_p">
								<span class="input_txt"><span><input type="text" name="yearSaleAmount" class="txt" value="${vendor.yearSaleAmount }" maxlength="7" onkeyup="displayComma(this, this.value);" style="width:76px;"></span></span> 백만원
							</p>
						</td>

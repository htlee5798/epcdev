 ...
 function initGrid(){
	$("#tabList").jqGrid({
		...
		colModel:[
			...
			{name:'ATTR_PI_TYPE'	, index:'ATTR_PI_TYPE'		, sortable:false		, width:130		,align:"center"		},
			{name:'ATTR_NM'			, index:'ATTR_NM'			, sortable:false		, width:130		,align:"center"		},
			{name:'ATTR_ID'			, index:'ATTR_ID'			, sortable:false		, width:350		,align:"center"		},
			{name:'ATTR_VAL_NM'		, index:'ATTR_VAL_NM'		, sortable:false		, width:130		,align:"center"		},
			{name:'ATTR_VAL_ID'		, index:'ATTR_VAL_ID'		, sortable:false		, width:350		,align:"center"		}
		],
...
function eventSearch(){
	...
	searchInfo.attrPiType	= document.form1.attrPiType.value;
	
	//grid data clear
	$("#tabList").jqGrid('clearGridData');
	
	$("#tabList").jqGrid('setGridParam',{
		url:'<c:url value="/edi/product/selectEcStdAttrMapping.do"/>',		// url 주소
				...
				<div id="wrap_menu">
					...
					<div class="wrap_search">
						...
						<div class="bbs_search">
							<ul class="tit">
								<li class="tit">EC 카테고리별 속성 조회</li>
							...
							<table class="bbs_search" cellpadding="0" cellspacing="0"
								...
								<tr>
									<th>상품속성 구분</th>
									<td><select id="attrPiType" name="attrPiType" class="required"
										style="width: 150px;">
											<option value="">선택</option>
											<option value="I">옵션형 상품</option>
											<option value="P">단일형 상품</option>
									</select></td>
									<th></th>
									<td></td>
								</tr>
								<table  cellpadding="0" cellspacing="1" border="0" width=100% bgcolor=efefef>
									<tr>
										<td colspan="4" bgcolor=ffffff>
											<strong>&nbsp;<font color="red">상품구분 : I = 옵션형 상품 / P = 단일형 상품</font></strong>
										</td>
									</tr>
								</table>
							</table>

...
<script>
	...
	function submitProductData() {
		//window.open("${ctx}/edi/product/brand.do");
		$("form[name=productDataForm]").submit();
	}
...
<body>
	<div id="content_wrap">
	<div>
		<div id="wrap_menu"> 상품정보 업로드
			<form name="productDataForm" id="uploadForm" action="${ctx}/edi/product/PEDMPRO000410.do" method="POST" enctype="multipart/form-data">
				<input type="file" name="productData" class='onlineImage' />&nbsp;&nbsp;
				<a href="javascript:submitProductData();" class=btn ><span>전송</span></a>
			</form>							

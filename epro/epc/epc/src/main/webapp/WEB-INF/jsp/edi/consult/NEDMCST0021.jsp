		...
		<div id="wrap_menu">
			...
			<div class="wrap_search">
				...
				<div class="bbs_search">
					<ul class="tit">
						<li class="tit"><spring:message code="epc.cst.tab2.txt"/></li>
					</ul>
				</div>
			</div>
			<div class="wrap_con">
				...
				<div class="bbs_list">
					...
					<tr class="r1">
						<td align="center">
							<div class="con_title">
								<a href='<c:url value="/edi/consult/NEDMCST0020.do"/>'><img src="/images/epc/edi/consult/vendor_2.gif" ></a>
								<a href='<c:url value="/edi/consult/NEDMCST0021.do"/>'><img src="/images/epc/edi/consult/salepromotion_1.gif" ></a>
					...
					<tr class="r1">
						<td align="center">
							<div class="con_title">
								<u><font color="blue">롯데마트 판매장려금 관련, http://partner.lottemart.com/epc</font></u><br>내 공지사항을 참조하시기 바랍니다.	
							</div><br>
						</td>
					</tr>
					</table>

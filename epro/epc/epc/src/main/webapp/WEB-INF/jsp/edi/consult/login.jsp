	...
	<div id="con_wrap">
		...
		<div class="con_area">
			...
			<div class="box_gray box_login">
				<p class="txt_btxt"><!-- 고객님의 --> <em>사업자번호</em>와 <em>비밀번호</em>를 입력해주세요.<br><em>처음 사용자</em>는 사용하실 비밀번호를 입력하시면 됩니다.</p>
				...
				<fieldset>
					...
					<div class="member_login">
						<dl class="input_info clearfloat">
							<dt>사업자번호</dt>
							<dd><span class="input_txt"><span><input type="text" name="bman_no1"  maxlength="3" class="txt"  onKeyUp="next_BizNo2(this.value.length,document.MyForm.bman_no2, this)" style="width:95px;" ID="Text1"></span></span> - <span class="input_txt"><span><input type="text"  name="bman_no2" maxlength="2"  onKeyUp="next_BizNo3(this.value.length,document.MyForm.bman_no3, this)" class="txt" style="width:95px;" ID="Text2"></span></span> - <span class="input_txt"><span><input type="text" name="bman_no3" maxlength="5"  onKeyUp="next_BizNo4(this.value.length,document.MyForm.password, this)" class="txt" style="width:95px;" ID="Text3"></span></span></dd>
					<!-- 
							<dt>비밀번호</dt>

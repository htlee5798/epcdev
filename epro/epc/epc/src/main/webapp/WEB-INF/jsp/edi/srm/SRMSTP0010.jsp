...
<%--
	Page Name 	: SRMSTP0010.jsp
	Description : 절차안내(롯데마트)
	...
	<div id="container">
		...
		<div class="inner sub_wrap">
			...
			<div class="sub_top">
				...
				<p class="page_path">HOME <span><spring:message code="header.menu.text1" /></span> <span><spring:message code="text.srm.field.step.tab1" /></span></p>
			</div><!-- END 서브상단 -->
			...
			<div class="content">
				...
				<!-- 서브 탭 -->
				<ul class="sub_tab">
					<li class="on"><a href="<c:url value="/edi/srm/SRMSTP0010.do" />"><spring:message code="text.srm.field.step.tab1" /></a></li>	<!-- 롯데마트 -->
				...
				<!--  
				<h3 class="tit_star"><spring:message code="text.srm.field.srmstp0010.title" /></h3>	<%-- 롯데마트는 --%>
				<p class="pl15">
					<spring:message code="text.srm.field.srmstp0010.contents" />
					<%-- 1998년 강변점 오픈을 시작으로 현재 전 세계 다수의 매장을 운영하며 2009년에는 국내외 매장 수 1위를 달성하였습니다.<br>첨단시설과 교통, 편리한 입지와 고품질 상품을 최저가격으로 판매하는 차별전략으로 고객을 맞이하고 있습니다. --%>
				</p>
				-->
				...
				<ul class="process_step">
					...
					<li><div class="circle"><div class="incircle"><span><spring:message code="text.srm.field.step5" /></span><em><spring:message code="text.srm.field.step.process6_1" /></em></div></div></li>	<%-- 1차 입점심사 완료--%>
					<li><div class="circle"><div class="incircle"><span><spring:message code="text.srm.field.step6" /></span><em><spring:message code="text.srm.field.step.process6_2" /></em></div></div></li>	<%-- 2차 내부심사 --%>
				...
				<table class="tbl_st1">
					...
					<tbody>
						<tr id="p1">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0010.process1" />
						...
						<tr id="p2">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0010.process2" />
						...
						<tr id="p3">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0010.process3" />
						...
						<tr id="p4">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0010.process4" />
						...
						<tr id="p5">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0010.process6_1" />
						...
						<tr id="p6">
							...
							<td> 
								<spring:message code="text.srm.field.srmstp0010.process6_2" />
								<%-- 입점 확정 결정에 따라 관련된 서류구비 및 계약서 작성을 진행합니다.
								<br>
								입점 확정 후 파트너사 코드가 생성된 이후에는 발주에 따른 납품을 하시면 됩니다. --%>
							</td>

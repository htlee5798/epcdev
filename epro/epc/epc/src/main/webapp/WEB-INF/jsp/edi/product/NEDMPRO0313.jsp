<%--
	Page Name 	: NEDMPRO0313.jsp
	Description : 팀 정보 조회 팝업
	Modification Information
	
	  수정일 			  수정자 				수정내용
	---------- 		---------    		-------------------------------------
	2025.04.21 		park jong gyu	 		최초생성
...
function doSearch(pageIndex){
	...
	let searchInfo = { 
				'depCdTxt' : $('input[name="depCdTxt"]').val()
	};
	...
	$.ajax({
		...
		type : 'post',
		dataType : 'json',
		url : '<c:url value="/edi/product/selectDepCdList.json"/>',
...
<tr class="r1"  bgcolor=ffffff>
	...
	<td align="center" style="text-align: center;">
		<a href="javascript:void(0);" onclick="selectDepCd(this);">
			<c:out value="\${depCd}" />	
		</a>
	</td>
	<td align="left"><c:out value="\${depCdTxt}" /></td>

	<input type="hidden" name="depCd" value="<c:out value='\${depCd}'/>"/>
	<input type="hidden" name="depCdTxt" value="<c:out value='\${depCdTxt}'/>"/>
</tr>
</script>
	...
	<div class="bbs_search2" style="width:100%;">
        ...
        <table class="bbs_search" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
            	<th>팀코드&팀명</th>
            	<td colspan="3">
            		<input type="text" name="depCdTxt" id="depCdTxt" value="<c:out value='${depCdTxt}'/>" style="width: 40%;">
				</td>
            </tr>
        </table>
        <!---------------------------------------------------- end of table -- -->

...
<body>
<input type="hidden" id="isMart"  name="isMart" value="<c:out value='${isMart}'/>"/>
						...
						<table  class="bbs_list2" cellpadding="0" cellspacing="0" border="0" width="100%" >	
							...
							<c:forEach items="${ecDisplayCategoryList}" var="ecDisplayCategoryList" varStatus="index" >
								<tr class="r1" >
									...
									<td align="center">
										<a href="javascript:selectEcDisplayCategory('<c:out value="${ecDisplayCategoryList.DISP_CAT_CD}"/>', '<c:out value="${ecDisplayCategoryList.DISP_CAT_NM}"/>', '<c:out value="${ecDisplayCategoryList.DISP_YN}"/>')">
											<c:out value='${ecDisplayCategoryList.DISP_CAT_CD}'/>
										</a>
									</td>
									<td align="left" style="padding-left:5px">
											<c:out value='${ecDisplayCategoryList.DISP_CAT_NM}'/>
									</td>
								</tr>
							</c:forEach>

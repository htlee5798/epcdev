				...
				<c:when test="${not empty list}">
					<c:forEach var="list" items="${list}">
							<tr>
								...
								<td align="center"><a href="javascript: popupPushValueadmin2('<c:out value="${list.VENDOR_ID}"/>','<c:out value="${list.VENDOR_NM}"/>','<c:out value="${list.PARAM_CONO}"/>');"><c:out value='${list.VENDOR_NM}'/></a></td>

				...
				<div class="bbs_search3">
					...
					<table class="bbs_grid2" cellspacing="0" border="0">
						...
						<tr><th><span class="star"></span>협력사코드</th>
							<td><input type="text" id="vendorId" name="vendorId" value="<c:out value='${searchVO.vendorId }' />" onKeyPress="enterKey();" maxlength="20" style='width: 80%;ime-mode:disabled'></td>
							<th><span class="star"></span>협력사명</th>
							<td><input type="text" id="vendorNm" name="vendorNm" value="<c:out value='${searchVO.vendorNm }' />" onKeyPress="enterKey();" maxlength="100" style="width: 90%;"></td>
						</tr>
					</table>
				</div>
				<!-- 	1검색조건 // -->

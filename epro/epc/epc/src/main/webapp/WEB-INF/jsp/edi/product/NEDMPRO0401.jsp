...
$(document).ready(function(){
	...
	//상품 플래그 (R:등록 S:조회)
	var screenFlag  = "<c:out value='${screenFlag}' />";
...
<body>
	...
	<input type="hidden" id="propRegNo" name="propRegNo" value="<c:out value='${propRegNo}'/>" />
	<input type="hidden" id="rnum" name="rnum" value="<c:out value='${rnum}'/>" />
	<input type="hidden" id="screenFlag" name="screenFlag" value="<c:out value='${screenFlag}'/>" />
	<input type="hidden" id="prdtSpecRange" name="prdtSpecRange" value="<c:out value='${prdtSpecRange}'/>" />
	<input type="hidden" id="prdtSpecSex" name="prdtSpecSex" value="<c:out value='${prdtSpecSex}'/>"/>
	<input type="hidden" id="prdtSpecAge" name="prdtSpecAge" value="<c:out value='${prdtSpecAge}'/>"/>
		<div id="popup">
				...
				<div class="bbs_search3">
					...
					<table class="bbs_list" cellspacing="0" border="0">
						...
						<tr>
							...
							<td colspan="3">
								<html:codeTag objId="priceFg" objName="priceFg"    parentCode="PRRAN"   dataType="NTCPCD"   comType="CHECKBOX" orderSeqYn="Y"  formName="form"/>
						...
						<tr>
							...
							<td colspan="3">
								<html:codeTag objId="customAgeFg" objName="customAgeFg"    parentCode="PRAGE"  dataType="NTCPCD"  comType="CHECKBOX" orderSeqYn="Y"  formName="form"/>
						...
						<tr>
							...
							<td colspan="3">
								<html:codeTag objId="customGenderFg" objName="customGenderFg"    parentCode="PRSEX"  dataType="NTCPCD"  comType="CHECKBOX" orderSeqYn="Y"  formName="form"/>

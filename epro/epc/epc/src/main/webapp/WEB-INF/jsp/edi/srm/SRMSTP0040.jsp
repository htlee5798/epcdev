...
<%--
	Page Name 	: SRMSTP0040.jsp
	Description : 절차안내(임대매장)
	...
	<div id="container">
		...
		<div class="inner sub_wrap">
			...
			<div class="sub_top">
				...
				<p class="page_path">HOME <span><spring:message code="header.menu.text1" /></span> <span><spring:message code="text.srm.field.step.tab4" /></span></p>
			</div><!-- END 서브상단 -->
			...
			<div class="content">
				...
				<ul class="sub_tab">
					...
					<li class="on"><a href="<c:url value="/edi/srm/SRMSTP0040.do" />"><spring:message code="text.srm.field.step.tab4" /></a></li>	<!-- 임대매장 -->
					<!--  <li><a href="<c:url value="/edi/srm/SRMSTP0050.do" />"><spring:message code="text.srm.field.step.tab5" /></a></li>-->		<!-- 지원구매 -->
				</ul><!-- END 서브 탭 -->

				<h3 class="tit_star"><spring:message code="text.srm.field.srmstp0040.title" /></h3>	<%-- 임대매장은 --%>
				<p class="pl15"><spring:message code="text.srm.field.srmstp0040.contents" /></p>	<%-- 롯데마트 및 맥스(MAXX) 매장 내 고객편의를 위한 식품/비식품 판매시설 입니다.  --%>
				...
				<table class="tbl_st1">
					...
					<tbody>
						<tr id="p1">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0040.process1" />
						...
						<tr id="p2">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0040.process2" />
						...
						<tr id="p3">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0040.process3" />
						...
						<tr id="p4">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0040.process5_1" />
						...
						<tr id="p5">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0040.process5_2" />
								<%-- 입점 확정 결정에 따라 관련된 서류구비 및 계약서 작성을 진행합니다.
								<br>
								입점 확정 후 MD협의에 따라 진행됩니다. --%>
							</td>

...
<script>
	...
	function doSearch() {
		...
		var dataInfo ={};
		dataInfo["STARTDATE"] = "<c:out value='${dlyProdInfo.formStartDate}' />";
		dataInfo["ENDDATE"] =   "<c:out value='${dlyProdInfo.formEndDate}' />";
		dataInfo["TAB1"] = TAB1;
		dataInfo["TAB2"] = TAB2;
		dataInfo["TAB3"] = TAB3;
		dataInfo["REQCOMMON"] = getReqCommon();

		rfcCall("INV0660" , dataInfo);
	}

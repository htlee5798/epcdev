...
<script>
	...
	function doSearch() {
		...
		if(dateValid()){
			$.ajax({
				...
				url : '<c:url value="/edi/payment/NEDMPAY0130Select.json"/>',
	...
	function popupSearch(tbName1, tbName2, tbName3){		
		...
		var bodyValue = "";
		bodyValue += "<CAPTION><spring:message code='epc.pay.dash.janek'/><br>";
	...
	function forwarding(val) {
		...
		$("#searchForm").attr("action", "<c:url value='/edi/payment/NEDMPAY0110.do'/>");
		$("#searchForm").submit();
	}
	...
	function printText(){
		...
		$("#searchForm").attr("action", "<c:url value='/edi/payment/NEDMPAY0130Text.do'/>");
		$("#searchForm").submit();	
...
<tr class="r1">
	<td align="center"><a href="javascript:forwarding('<c:out value="\${buyYm}"/>');"><c:out value="\${buyYm}"/></a></td>
	...
	<td align="right"><c:out value="\${remSum}"/></td>
</tr>
</script>
<!-- Data List Templete -------------------------------------------------------------------------------------------------------------->
</head>
			...
			<div class="wrap_con">
				...
				<div class="bbs_list">
					...
					<tr>
						...
						<th><spring:message code='epc.pay.header.subSum'/></th>
						<th>&nbsp;</th>
					</tr>
					</table>
					<div style="width:100%; height:409px; overflow-x:hidden; overflow-y:scroll; table-layout:fixed;">
					...
					<colgroup>
						...
						<tr style="display:none;" class="r1 sum">
							<th align="center" colspan="3"><b><spring:message code='epc.pay.header.totalSum'/></b></th>
							<th align="right"><b id="rem_buy_amt_sum"></b></th>
							<th align="right"><b id="rem_vat_sum"></b></th>
							<th align="right"><b id="rem_sum_sum"></b></th>
							<th>&nbsp;</th>
						</tr>
							<tr style="display:none;" class="empty"><td colspan=6>&nbsp;</td><th width=17>&nbsp;</th></tr>
		...
		<div id="footbox">
			...
			<div class="location">
				<ul>
					...
					<li class="last"><spring:message code='epc.pay.janek'/></li>
				</ul>
			</div>
		</div>
	</div>

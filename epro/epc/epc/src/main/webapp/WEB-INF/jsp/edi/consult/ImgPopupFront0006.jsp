...
<script>
	...
	function closeWin(cookiename)  {
	    setCookieToday(cookiename, 'popcookie201302050' , 1);        
	    top.close();
	}
	...
	<tr>
		<td bgcolor=ffffff>
			<table cellspacing=0 cellpadding=0 border=0 width=100%>
				<TR>
					<td background="/images/epc/popup/201302050.jpg" WIDTH="400" HEIGHT="571">
				</td>			
			</TR>
			<TR>
			<td>
				<input type="checkbox" id="user_chk" name="user_chk" value="" onclick="closeWin('popcookie201302050');"> 이 메세지를 더이상 표시하지 않음.
			</td>
			</TR>
			</table>
			</td>

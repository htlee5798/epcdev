...
<%
	  response.setHeader("Content-Disposition", "attachment;filename=PSCMORD000401.xls;") ;
		...
		<c:when test="${list != null}">		
			<c:forEach var="result" items="${list}">
					<tr>
						...
						<td align="center" style='mso-number-format:"\@";'><c:out value="${result.PROD_CD}"/></td>
						<td align="center" style='mso-number-format:"\@";'><c:out value="${result.PROD_NM}"/></td>

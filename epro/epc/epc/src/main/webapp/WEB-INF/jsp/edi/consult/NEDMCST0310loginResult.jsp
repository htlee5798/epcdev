...
$(document).ready(function(){
	...
	$("#MyForm #password").keypress(function(event) {
		if(event.keyCode  == 13) {
			confirm_submit();
		}	
	});
...
alert('${resultMessage }');
	...
	function openBizNo() {
	    if(!checkbmanNo3(MyForm.bmanNo1, MyForm.bmanNo2, MyForm.bmanNo3))
		{ 
			return;
		}
		...
		popUrl = "pop_message_00.asp?strMsg=" + strMsg + "&objFocus=MyForm.bmanNo1"
		openPopup2(popUrl,'ID');
	}

	function checkbmanNo3(obj1,obj2,obj3)          
	{          
	...
	function FindPwd()
	{
		var popurl = "<c:url value='/epc/edi/consult/NEDMCST0310findPassword.do'/>";
...
<form name="MyForm" method="post"  action="<c:url value='/epc/edi/consult/NEDMCST0310checkVendorBusinessNoResult.do'/>" id="MyForm">
	...
	<div id="con_wrap">
		...
		<div class="con_area">
			...
			<div class="box_gray box_login">
				<p class="txt_btxt"><spring:message code='text.consult.field.bmanNoNpw'/></p>
				...
				<fieldset>
					...
					<div class="member_login">
						<dl class="input_info clearfloat">
							...
							<dd>
							  <span class="input_txt"><span><input type="text" name="bmanNo1" id="bmanNo1" maxlength="3"  onKeyUp="next_BizNo2(this.value.length,document.MyForm.bmanNo2, this)"  class="txt" style="width:95px;" ></span></span> 
							...
							<dd class="end"><span class="input_txt"><span><input type="password" name="password" id="password" maxlength="10"  class="txt" style="width:349px;"></span></span></dd>
					
						</dl>
						<div class="btn_login"><img  src="/images/epc/edi/consult/btn-confirm_2.gif" onClick="confirm_submit();" style="cursor:hand;"></div>
					</div>
					<!-- //로그인 입력 -->
				</fieldset>

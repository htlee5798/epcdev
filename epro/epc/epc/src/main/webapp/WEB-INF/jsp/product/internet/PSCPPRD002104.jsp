	 ...
	 <div class="popup_contents" >
		...
		<div class="bbs_search3">
				...
				<table width="100%" cellspacing="1" cellpadding="1" bgcolor=dddddd border=0 align=center>
                    	...
                    	<input type="hidden" name="prodImgNo" id="prodImgNo" value="${prodInfo.PROD_IMG_NO}"/>
                    	<input type="hidden" name="mdSrcmkCd" id="mdSrcmkCd" value="${prodInfo.MD_SRCMK_CD}"/>
                        ...
                        <tr bgcolor=white>
                        	<td align=center valign=center >
                    			<div style="height:500px;width:500px;overflow-y:scroll;overflow-x:scroll;white-space:nowrap;"><img src="${beforeImg}"></DIV>
      						</td>
      						<td align=center valign=center>
      							<div style="height:500px;width:500px;overflow-y:scroll;overflow-x:scroll;white-space:nowrap;"><img src="${afterImg}"></DIV>
      						</td>


<!--                     		<td align=center valign=center > -->
<!--                     			<DIV style="height:500px;width:500px"><img src="//simage.lottemart.com/lim/static_root/images/prodimg/L0000/L000000177890_1_500.jpg"></DIV> -->
<!--       						</td> -->
<!--       						<td align=center valign=center > -->
<!--       							<DIV style="height:500px;width:500px"><img src="//simage.lottemart.com/lim/static_root/images/prodimg/L0000/L000000177890_1_500.jpg"></DIV> -->
<!--       						</td> -->

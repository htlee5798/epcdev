...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    attachEvent.moveTab(); // TAB 이벤트
    modifyResultHtml.appendHtml(); // 영양성분 속성 입력 DOM 객체 생성

    attachEvent.blurNutAtt();  
  });
  ...
  var nutFunction = {
	...
	validateNutAmt : function() {
      ...
      var errMsg = "";
		  ...
		  if (nutAmt) { // 영양성분 속성 값이 있는 경우 값 검사

...
<%
	if (detectXSSEx(request.getParameter("save_string")) != null && !"".equals(detectXSSEx(request.getParameter("save_string")))) {
		...
		String decodeSHTML = null;
		try {
			decodeSHTML = java.net.URLDecoder.decode(sHTML, "utf-8");
		} catch(IllegalArgumentException e) {
			sHTML = sHTML.replaceAll("%", "%25");
			decodeSHTML = java.net.URLDecoder.decode(sHTML, "utf-8");
		}

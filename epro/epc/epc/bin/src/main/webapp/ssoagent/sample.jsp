...
try
{
	...
	if(status == AuthStatus.SSOFirstAccess) {
		...
		//인증성공
		returnUrl = SecureUtil.stripXSS(request.getParameter(auth.getSsoProvider().getReturnUrlTagName()));
    ...
    <form id="form1" method="post">
        ...
        <%} else {%>
        	...
        	사용자 정보 : <br /><%=userInfo%><br /><br />
       		...
       		<br/><br/><br/><br/><br/>
			<a href="/lottemart-epc/common/viewSSOEpcAdmLoginForm.do" target="_blank">SSO</a>
        <%} %>
    </form>

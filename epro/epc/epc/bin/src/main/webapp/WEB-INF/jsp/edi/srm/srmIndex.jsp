...
<frameset rows="69px,*" frameborder="0" framespacing="0">
	<frame src="<c:url value="/edi/main/viewSrmTop.do"/>" name="gnbFram"  border="0" marginheight="0" marginwidth="0" scrolling="no">
	<frameset cols="190px,*" id="widthFram" name="widthFram" frameborder="0" framespacing="0">
		<frame src="<c:url value="/edi/main/viewSrmLeft.do"/>?pgm_code=<c:out value="${paramMap.pgm_code}"/>&pgm_sub=<c:out value="${paramMap.pgm_sub}"/>" id="lnbFram" name="lnbFram"  border="0" marginheight="0" marginwidth="0" scrolling="no">
		<c:choose>

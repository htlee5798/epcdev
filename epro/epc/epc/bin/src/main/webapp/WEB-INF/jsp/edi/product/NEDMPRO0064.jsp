...
$(document).ready(function(){
	...
	ibdata.Cols = [
	  ...
	  , {Header:"속성구분", 	        		Type:"Text", 					SaveName:"ATTR_PI_TYPE",   					Align:"Center", 	 				Width:130, 	Edit:0}
	  , {Header:"속성유형명", 					Type:"Text", 					SaveName:"ATTR_NM", 					Align:"Center", 	 				Width:130, 		Edit:0}
	  , {Header:"속성ID", 				Type:"Text", 					SaveName:"ATTR_ID",      Align:"Center", 					Width:350, 		Edit:0}
	  , {Header:"속성값", 					Type:"Text", 					SaveName:"ATTR_VAL_NM", 					Align:"Center", 	 				Width:130, 		Edit:0}
	  , {Header:"속성값ID", 				Type:"Text", 					SaveName:"ATTR_VAL_ID",      Align:"Center", 					Width:350, 		Edit:0}
	];
...
function goPage(currentPage){
	var url = '<c:url value="/edi/product/selectEcStdAttrMapping.do"/>';
...
function getParam(currentPage) {
	...
	param.attrPiType	= document.form1.attrPiType.value;

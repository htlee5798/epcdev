...
function goPage(pageIndex){
	...
	var url = '<c:url value="/statistics/selectCoolGramEdmSalesList.do"/>';
...
function doExcel(){
	...
	var url = '<c:url value="/statistics/selectCoolGramEdmSalesListExecl.do"/>';
	f.pageIndex.value = 1;
	f.action = url;
	f.submit();	

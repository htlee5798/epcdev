...
<title>(주)롯데마트 신한은행 조기 자금지원 안내</title>


<script>

	function closeWin(cookiename)  {
	    setCookieToday(cookiename, 'popcookie20170313' , 1);        
	    top.close();
	}
	...
	<tr>
		<td bgcolor=ffffff>
			<table cellspacing=0 cellpadding=0 border=0 width=100%>
				<TR>
				 	<img alt="" src="/images/epc/popup/20170313popUp.jpg" width="520" height="675">
				</td>			
			</TR>
			<TR>
			<td>
				<input type="checkbox" id="user_chk" name="user_chk" value="" onclick="closeWin('popcookie20170313');"> 이 메세지를 더이상 표시하지 않음.
			</td>
			</TR>
			</table>
			</td>

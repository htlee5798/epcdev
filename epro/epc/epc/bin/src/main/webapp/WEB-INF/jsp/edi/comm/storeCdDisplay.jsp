...
<body>
<form name="dataForm" id="dataForm" action="${ctx }/edi/product/selStoreCdList.do" method="post">
...
<div id="storePopup">
								...
								<tr class="r1" >
									...
									<td align="center" style="padding-left:5px">
										<a href="javascript:void(0);" onclick="selectStoreCdDisplay(this);">
											${storeCdDisplay.strCd}
										</a>
										<input type="hidden" name="strCd" value="${storeCdDisplay.strCd}"/>
									</td>
									<td align="center">
										<c:out value="${storeCdDisplay.strNm}"></c:out>
										<input type="hidden" name="strNm" value="${storeCdDisplay.strNm}"/>
									</td>
									<td align="center">
	...
	<div class="paging">
	    ...
	    <c:if test="${paginationInfo.currentPageNo < paginationInfo.totalPageCount}">
	        ...
	        <a href="javascript:goPage(${paginationInfo.totalPageCount})">마지막</a>
	    </c:if>
	</div>

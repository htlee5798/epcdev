...
<%
	  response.setHeader("Content-Disposition", "attachment;filename=PSCMSTA000301.xls;") ;
			...
			<c:choose>
				<c:when test="${not empty list}">
					...
					<tr class="r1">
						...
						<td style='mso-number-format:"\@";'>${result.MEMBER_NO}</td>
						<td style='mso-number-format:"\@";'>${result.MEMBER_NM}</td>
						<td style='mso-number-format:"\@";'>${result.ALGN_MEMBER_NO}</td>
						<td style='mso-number-format:"\@";'>${result.ADJ_CD}</td>

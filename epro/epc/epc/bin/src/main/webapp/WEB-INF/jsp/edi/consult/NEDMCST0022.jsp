		...
		<div id="wrap_menu">
			...
			<div class="wrap_search">
				...
				<div class="bbs_search">
					<ul class="tit">
						<li class="tit"><spring:message code="epc.cst.tab3.txt"/></li>
					</ul>
				</div>
			</div>
			<div class="wrap_con">
					...
					<tr class="r1">
						<td align="center">
							<div class="con_title">
								...
								<a href='<c:url value="/edi/consult/NEDMCST0022.do"/>'><img src="/images/epc/edi/consult/location_01.gif" ></a>
							</div>
						</td>
					</tr>
					<tr class="r1">
						<td  align="center">
							<div class="con_title">
								<h1><img src="/images/epc/edi/consult/location.jpg" ></h1>
							</div><br>
						</td>
					</tr>
					</table>

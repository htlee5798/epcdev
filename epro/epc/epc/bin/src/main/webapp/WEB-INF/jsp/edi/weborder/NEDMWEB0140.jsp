...
<script  type="text/javascript" >
	...
	/* 초기 설정 */
	function _init(){
		_setTbodyNoResult($("#datalist"), 	12, "<spring:message code='text.web.field.srchInit16'/>");	// prod tBody 설정
	}	
	...
	function doSearch(){
		...
		<%-- 조회조건 검증 ============================= --%>
		if(!$.trim($('#rrlDy').val())){
			alert("<spring:message code='text.web.field.srchInit01401'/>");
			$("#rrlDy").focus();
			return false;
		}
		...
		$.post(
				"<c:url value='/edi/weborder/NEDMWEB0140Select.do'/>",
				JSON.stringify(str),
				function(data){
					if(data.state !="0"){
					 	alert("<spring:message code='msg.web.alert.a01401'/>");				// 검색중 Exception 발생(data.message 로 확인가능) 
					 	hideLoadingMask();
					 	return;
					}else{
	...
	function _viewMdState(obj){
		...
		if(regStsCd != '1') {
			message = "<spring:message code='text.web.field.sendError'/>";
		}
		alert(message); 
		...
		<div id="wrap_menu">
			...
			<div class="wrap_search">
				...
				<div class="bbs_search">
					...
					<tr>
						<th><spring:message code='text.web.field.rtnProcDt'/></th>
						<td>
							<input type="text" class="day" id="rrlDy" name="rrlDy" readonly value="<c:out value="${paramMap.rrlDy}" />" style="width:80px;" ><img src="/images/epc/layout/btn_cal.gif" class="middle" onClick="openCal('searchForm.rrlDy');" style="cursor:hand;" />
						</td>
					...
					<tr>
						<th><spring:message code='text.web.field.srchInit01402'/></th>
						<td>
							<input type="Radio" name="regStsfg" value="1" <c:if test="${paramMap.regStsfg eq '1'}"> Checked</c:if> /> <spring:message code='text.web.field.srchInit01403'/>
							<input type="Radio" name="regStsfg" value="2" <c:if test="${paramMap.regStsfg eq '2'}"> Checked</c:if> /> <spring:message code='text.web.field.srchInit01404'/>
							<input type="Radio" name="regStsfg" value="3" <c:if test="${paramMap.regStsfg eq '3'}"> Checked</c:if> /> <spring:message code='text.web.field.srchInit01405'/>
						</td>
						<th></th>
						<td></td> 
						<%-- <th>조정승인</th>
			...
			<div class="wrap_con">
				...
				<div class="bbs_list">
					<ul class="tit">
						<li class="tit"><spring:message code='text.web.field.srchInit01406'/></li>
					</ul>
					...
					<table id="dataTable" cellpadding="1" cellspacing="1" border="0" width=100% bgcolor="#EFEFEF">
                        ...
                        <tr bgcolor="#e4e4e4" align=center> 
	                      ...
	                      <th rowspan="2"><spring:message code='epc.web.header.h01401'/></th>
	                      <th colspan="7"><spring:message code='epc.web.header.h01402'/></th>
	                      <th colspan="2"><spring:message code='epc.web.header.h01403'/></th>
	                      <th rowspan="3"></th>
                        </tr>
                        <tr bgcolor="#e4e4e4" align=center>
						  <th><spring:message code='epc.web.header.h01404'/></th>
                          <th><spring:message code='epc.web.header.h01405'/></th>
                          <th><spring:message code='epc.web.header.h01406'/></th>
                          <th><spring:message code='epc.web.header.h01407'/></th>
                          <th><spring:message code='epc.web.header.h01408'/></th>
                          <th><spring:message code='epc.web.header.h01409'/></th>
                          <th><spring:message code='epc.web.header.h014010'/></th>
                        <!--   <td>단위</td> -->
                          <th><spring:message code='epc.web.header.h014011'/><br><spring:message code='epc.web.header.h014012'/></th>
                          <th><spring:message code='epc.web.header.h014013'/></th>
                        </tr>
                        <tr bgcolor="87CEFA"> 
                        		<td colspan="2" bgcolor="#929292"><span style="width:100%; font-weight: bold; text-align: center; color: #ffffff;"><spring:message code='epc.web.header.h014014'/></span></td>
		...
		<div id="footbox">
			...
			<div class="location">
				<ul>
					...
					<li class="last"><spring:message code='epc.web.menu.totalReturn'/></li>
				</ul>
			</div>
		</div>
	</div>
...
<font color='white'><b>NEDMWEB0140.jsp</b></font>

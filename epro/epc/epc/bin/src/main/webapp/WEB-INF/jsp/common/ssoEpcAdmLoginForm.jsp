...
<body>
	...
	<input type="hidden" name="repVendorId"  id="repVendorId" value="" />
		<div id="wrap_login2">
			...
			<dl class="login_cnt">
				<dt>아이디</dt>
				<dd style="margin-right:250px;"><input type="text" class="txt_id" style="width:157px;" onClick="fRemoveClass(1);" OnKeyPress="javascript:checkKey(1);" name="loginId" value="${loginId }" readonly="readonly" /></dd>				

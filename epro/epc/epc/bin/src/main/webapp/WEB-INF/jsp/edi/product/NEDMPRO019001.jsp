            ...
            <div class="bbs_list">
              ...
              <div style="width: 100%; height: 100%; overflow-y: scroll; overflow-x: hidden; table-layout: fixed;">
                <table id="dataTable" cellpadding="1" cellspacing="1" border="0" width="100%" bgcolor=efefef>
                  ...
                  <tr bgcolor="#e4e4e4">
                    <th id="thAttNm">영양성분이름</th>
                    <th id="thAttCdVal">입력한 영양성분값</th>
  ...
  const pd = (function pageData() {
    ...
    return {
      fetchAttrAprvInfo: function() {
				...
				function _cvrtMinusOneToHypn(num) {
        ...
        function _getNutUnit(unit) {
          ...
          return unit;
				...
				function _getAttrAprvInfoRowHtml(prodAttrInfoRow) {
				  return "<tr>" 
				       + "<td align='center'>" + prodAttrInfoRow.NUT_NM + _getNutUnit(prodAttrInfoRow.UNIT) + "</td>"
				       + "<td align='center' style='line-height: 25px;'>" + _cvrtMinusOneToHypn(prodAttrInfoRow.NUT_AMT_REQ) + "</td>"
        ...
        function _fetchAttrAprvInfo() {
          const _url = '<c:url value="/edi/product/getProdNutAprv.json"/>';
          const _ajaxOpt = {
            method: "POST",
            headers: {

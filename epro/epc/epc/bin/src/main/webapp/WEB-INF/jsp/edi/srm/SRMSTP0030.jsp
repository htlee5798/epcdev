...
<%--
	Page Name 	: SRMSTP0030.jsp
	Description : 절차안내(롯데마트몰(Online))
	...
	<div id="container">
		...
		<div class="inner sub_wrap">
			...
			<div class="sub_top">
				...
				<p class="page_path">HOME <span><spring:message code="header.menu.text1" /></span> <span><spring:message code="text.srm.field.step.tab3" /></span></p>
			</div><!-- END 서브상단 -->
			...
			<div class="content">
				...
				<ul class="sub_tab">
					...
					<li class="on"><a href="<c:url value="/edi/srm/SRMSTP0030.do" />"><spring:message code="text.srm.field.step.tab3" /></a></li>		<!-- 롯데마트몰(Online) -->
				...
				<!-- 
				<h3 class="tit_star"><spring:message code="text.srm.field.srmstp0030.title" /></h3>	<%-- 롯데마트몰은 --%>
				<p class="pl15"><spring:message code="text.srm.field.srmstp0030.contents" /></p>	<%-- 국내외 매장수 1위의 롯데마트의 온라인 쇼핑몰로써, 오프라인 매장 상품 및 파트너사 상품을 공급하는 쇼핑몰입니다.  --%>
				-->
				...
				<ul class="process_step">
					...
					<li><div class="circle"><div class="incircle"><span><spring:message code="text.srm.field.step3" /></span><em><spring:message code="text.srm.field.step.process5" /></em></div></div></li>	<%-- 심사절차진행 --%>
					<li><div class="circle"><div class="incircle"><span><spring:message code="text.srm.field.step4" /></span><em><spring:message code="text.srm.field.step.process6_1" /></em></div></div></li>	<%-- 입점 확정 --%>
					<li><div class="circle"><div class="incircle"><span><spring:message code="text.srm.field.step5" /></span><em><spring:message code="text.srm.field.step.process6_2" /></em></div></div></li>	<%-- 입점 확정 --%>
				...
				<table class="tbl_st1">
					...
					<tbody>
						<tr id="p1">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0030.process1" />
						...
						<tr id="p2">
							...
							<td>
								<spring:message code="text.srm.field.srmstp0030.process2" />
								<%-- 신청한 정보를 평가하여 상담 및 품평회 여부를 결정하게 되며, 일정 및 세부사항에 대해 안내해드립니다. --%>
							</td>
						</tr>
						<tr id="p3">
							<th><spring:message code="text.srm.field.step.process5" /></th>	<%-- 심사절차진행 --%>
							<td>
								<spring:message code="text.srm.field.srmstp0030.process3" />
								<%-- 귀사의 상품에 대한 평가를 진행합니다. --%>
							</td>
						</tr>
						<tr id="p4">
							<th><spring:message code="text.srm.field.step.process6_1" /></th>	<%-- 입점확정 --%>
							<td>
								<spring:message code="text.srm.field.srmstp0030.process5_1" />
								<%-- 입점 확정 결정에 따라 관련된 서류구비 및 계약서 작성을 진행합니다.
								<br>
								입점 확정 후 파트너사 코드가 생성된 이후에는 고객 주문에 따라 배송을 하시면 됩니다. --%>
							</td>
						</tr>
						<tr id="p5">
							<th><spring:message code="text.srm.field.step.process6_3" /></th>	<%-- 입점확정 --%>
							<td>
								<spring:message code="text.srm.field.srmstp0030.process5_2" />
								<%-- 입점 확정 결정에 따라 관련된 서류구비 및 계약서 작성을 진행합니다.
								<br>
								입점 확정 후 파트너사 코드가 생성된 이후에는 고객 주문에 따라 배송을 하시면 됩니다. --%>
							</td>

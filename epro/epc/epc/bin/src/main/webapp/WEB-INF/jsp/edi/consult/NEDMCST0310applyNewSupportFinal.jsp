			...
			<div id="con_wrap">
				<div class="con_area">
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">						
							...
							<tbody>
								<tr>
									...
									<td>
										<c:choose>
											<c:when test="${vendor.tSubteamCd=='00022'}">
						           				<p class="td_p"><spring:message code='text.consult.field.ordTeam'/></p>
						           			</c:when>					           				
	           		 					</c:choose>	
									</td>
					...
					<div class="tb_v_common">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tbody>
								<tr>								
									<th><p><spring:message code='text.consult.header.mainProduct'/></p></th>
									...
									<td><p class="td_p"><c:out value='${vendor.yearSaleAmount }'/> <spring:message code='text.consult.field.onehunmillion'/></p></td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="tb_h_common_02">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<caption><spring:message code='text.consult.field.selfDiagnosis'/>(<spring:message code='text.consult.field.consultKind2'/>)</caption>
							<colgroup>
								<col width="100px">
								<col width="450px">
								<col width="100px">
								...
								<tr>
									...
									<td>
										<span class="input_txt" style="margin-left: 20px"><span>
											<input type="password" name="password"  id="password" maxlength="12" class="txt"	style="width: 150px;">
										</span></span>
									</td>
									<td></td>
									<td colspan="2">
				...
				<div class="btn_c_wrap mt30">
					<span class="btn_white"><span>
						<a href="javascript:checkApply_submit('<c:out value="${gubunBlock }"/>');"><spring:message code='button.consult.apply' /></a>
					</span></span>
				</div>
			</div>
		</div>

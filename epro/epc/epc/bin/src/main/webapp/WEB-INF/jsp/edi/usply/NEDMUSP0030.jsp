...
<script>
	...
	function doSearch() {
		...
		if(dateValid()){
			$.ajax({
				...
				url : '<c:url value="/edi/usply/NEDMUSP0030Select.json"/>',
	...
	function dateValid(){
		...
		if(startDate == "" || endDate == ""  ){
			...
			$("#searchForm input[name='srchStartDate']").focus();
			return false;
		}
	...
	function popupSearch(tbName1, tbName2){		
		...
		var bodyValue = "";
		bodyValue += "<CAPTION>미납정보상품별 현황표<br>";
	...
	function printText() {
		...
		$("#searchForm").attr("action", "<c:url value='/edi/usply/NEDMUSP0030Text.do'/>");
		$("#searchForm").submit();		
	}
...
<tr class="r1">
	...
	<td align="center" style="mso-number-format:'\@'"><a href="javascript:forwarding('<c:out value="\${srcmkCd}"/>','<c:out value="\${splyDy}"/>');"><c:out value="\${srcmkCd }"/></a></td>
		...
		<div id="wrap_menu">
			...
			<div class="wrap_con">
				...
				<div class="bbs_list">
					...
					<tr>
						<th><spring:message code='epc.usp.header.date'/></th>
		...
		<div id="footbox">
			...
			<div class="location">
				<ul>
					...
					<li class="last"><spring:message code='epc.usp.perProd'/></li>
				</ul>
			</div>
		</div>
	</div>

...
<div id="popup">
	...
	<div class="bbs_search2" style="width:100%;">
		<ul class="tit">
			...
			<li class="tit" style="padding-left:10px;">${ecCategoryFullName}</li>
            <li class="btn">
								...
								<tr class="r1" >
									...
									<td align="left">
										<input
											...
											id="${ospDisplayCategoryList.OSP_CATEGORY_ID}-ospCategory_${index.count}"
											onClick="clickOspCat(this);"
										/>
										<div style="padding-left:5px; display:inline;" id="div-ospCategory_${index.count}">
												${ospDisplayCategoryList.OSP_CATEGORY_FULL_NM}
										</div>
									</td>
									<td align="center" style="padding-left:5px">
										<input
											...
											id="repOspCategory_${index.count}"
									...
									<input
										...
										id="ospCatDispYn_${index.count}"
										value="${ospDisplayCategoryList.OSP_CATEGORY_DISP_YN}"
									/>
								</tr>
							</c:forEach>

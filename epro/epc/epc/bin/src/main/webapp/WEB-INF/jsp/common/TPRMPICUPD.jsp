...
<form name="dataForm" id="dataForm" method="POST">
	<input type="hidden" name="prodCd"    value="${tprMpicInfo.PROD_CD}"/>
	<input type="hidden" name="cid"       value="${tprMpicInfo.CID}">
	<input type="hidden" name="mpicSeq"   value="${tprMpicInfo.MPIC_SEQ}"/>
	<input type="hidden" name="accessKey" value="${tprMpicInfo.ACCESS_KEY}"/>
		...
		<div class="bbs_list">
			<ul class="tit">
		       ...
		       <col width=" " />
		        ...
		        <tr>
		        	<th>제목</th>
		        	<td><input type="text" name="title" value="${ tprMpicInfo.TITLE }"></td>
		        </tr>
		        <tr>
		        	<th>내용</th>
		        	<td><input type="text" name="content" value="${ tprMpicInfo.CONTENT }"></td>
		        </tr>
		        <tr>
		        	<th>사용여부</th>
		        	<td>

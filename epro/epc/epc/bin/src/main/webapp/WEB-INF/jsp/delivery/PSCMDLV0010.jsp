...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		createIBSheet2(document.getElementById("ibsheet1"), "mySheet", "100%", "422px");//380px
		...
		// Sort: 헤더클릭시 정렬, ColMove: 마우스로 헤더이동, ColResize:컬럼Resize, HeaderCheck: 헤더에 CheckBox 표시
		ibdata.Cols = [
       	    {Header:"순번",	 			Type:"Text", 	SaveName:"RNO",				Align:"Center",		 MinWidth: 35,	Sort:false, Edit:false}
      	  , {Header:"페널티 적용일",			Type:"Text", 	SaveName:"REG_DATE",			Align:"Center",		 MinWidth: 80,	Sort:false, Edit:false}
      	  , {Header:"상품코드",		 	Type:"Text", 	SaveName:"PROD_CD",		Align:"Center",		 MinWidth: 100,	Sort:false, Edit:false}
      	  , {Header:"상품명",		 	Type:"Text", 	SaveName:"PROD_NM",	 		Align:"Center",		 MinWidth: 300,	Sort:false, Edit:false}
      	  , {Header:"페널티\n적용 횟수",		 	Type:"Text", 	SaveName:"PENALTY_CNT",	 		Align:"Center",		 MinWidth: 90,	Sort:false, Edit:false}
      	  , {Header:"전시여부",		 	Type:"Text",	SaveName:"DISP_YN",	 	Align:"Center",		 MinWidth: 90,	Sort:false, Edit:false}
      	  , {Header:"품절여부",		Type:"Text", 	SaveName:"SOUT_YN",	 	Align:"Center",		 MinWidth: 90,	Sort:false, Edit:false}
		];
    ...
    function goPage(currentPage) {
        ...
        var url = '<c:url value="/delivery/pscmdlv0010/search.do"/>';
    ...
    function doExcel(){
    	...
    	var xlsUrl = '<c:url value="/delivery/pscmdlv0010/excel.do"/>';
    	var hideCols = '';
		...
		<div class="content_scroll">
			<form name="searchForm" id="searchForm" method="post">
				...
				<div id="wrap_menu">
						...
						<div class="bbs_search">
							...
							<table class="bbs_search" cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									...
									<th>상품명</th>
									<td>
										<input type="text" id="prodNm" name="prodNm" value="" style="width: 137px;">
									</td>																	
								</tr>		
								<tr>									
									<th>상품코드</th>
									<td>
										<input type="text" id="prodCd" name="prodCd" value="" style="width: 115px;">
									</td>									
									<th>품절여부</th>
									<td class="text"> 
										<select class="select" id="soutYn" name="soutYn">
											<option value="" >전체</option>
									...
									<td class="text">
										<select class="select" id="dispYn" name="dispYn">
											<option value="" >전체</option>
											<option value="Y" >Y</option>
											<option value="N" >N</option>
										</select>
								...
								<tr>									
									...
									<td class="text">
										<select name="penaltyCnt" id="penaltyCnt" class="select">
											<option value="" >전체</option>
					...
					<!-- 페이징 DIV -->
					<div id="pagingDiv" class="pagingbox1" style="width: 100%; display:none;">

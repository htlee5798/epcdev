...
<form name="MyForm" ID="Form1" action="<c:url value='/epc/edi/consult/NEDMCST0310insertStep1.do'/>" method="GET">
			...
			<div class="product-list clearfloat">
				<div class="fl_left mr10">
					<div class="tb_h_common_02">
						...
						<thead>
							<tr>
								<th width="82px" class="line"><spring:message code='epc.cst.text.teamNm'/></th>
								<th width="277px" class="line"><spring:message code='epc.cst.text.mainProd'/></th>
								<th width="*"><spring:message code='epc.cst.text.apply'/></th>
							</tr>
						</thead>
						<tbody>
						...
						<c:forEach items="${consultcategroyList}" var="consultcategroyList" varStatus="index" >
							 ...
							 <c:if test="${ setCnt > index.count }">
							 	<tr>
									<td class="team_name t_center"><c:out value='${consultcategroyList.teamNm }'/></td>
								<%-- <td class="t_center"><a href="javascript:openDetail('${consultcategroyList.teamCd}')" >${consultcategroyList.mainProd}</a></td> --%>
									<td class="t_center"><c:out value='${consultcategroyList.mainProd}'/></td>
									<td class="t_center"><span class="btn_white btn_w_td_ls"><span class="btn_td_w_01"><a href="javascript:confirm_submit_new('<c:out value="${consultcategroyList.teamCd}"/>');"><spring:message code='epc.cst.text.apply'/></a></span></span></td>
								</tr>
						 	<c:set var="oldTeamCd" value="<c:out value='${consultcategroyList.teamCd }'/>" />

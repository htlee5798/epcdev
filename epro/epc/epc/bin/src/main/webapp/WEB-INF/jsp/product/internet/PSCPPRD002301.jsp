...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		ibdata.Cols = [
		  ...
		  , {Header:"추가구성 상품코드", 	 	Type:"Text", 			SaveName:"ASSO_CD", 						Align:"Center", Width:120,   Edit:0, Cursor:'pointer', Color:'blue', FontUnderline:true}
		  , {Header:"추가구성 상품명",	 	 	Type:"Text", 			SaveName:"ASSO_NM", 	 	 	  			Align:"Left",   	  Width:220,   Edit:0, Ellipsis:true}
	...
	function goBoardPopup(){
		...
		var targetUrl = '<c:url value="/common/viewPopupProductList.do"/>?vendorId='+$("#detailForm #vendorId").val()+"&notInVal="+notInVal+"&onlineProdTypeCd=06";
...
<input type="hidden" id="prodLinkKindCd" name="prodLinkKindCd" value="06" />

...
// 		/* 단일상품일때만 판매코드 입력가능  이동빈 판매코드 필수*/
		...
		function selectOspDispCategoryList() {
	        let url = '<c:url value="/edi/product/ospDisplayCategory.do"/>';
		    let param = new Object();
			param.pgmId = "<c:out value='${newProdDetailInfo.pgmId}'/>";
        ...
        function initIBSheetGrid4() {
            ...
            ibdata.Cols = [
                {Header:"", Type:"CheckBox", 	    SaveName:"SELECTED", 	 		Align:"Center",  Width:25,    Sort:false}
                , {Header:"ZETTA 전시카테고리", Type:"Text", 			SaveName:"OSP_CATEGORY_FULL_NM", 	Align:"Left",      Width:465,   Edit:0}
                , {Header:"ZETTA 카테고리아이디", Type:"Text", 			SaveName:"OSP_CATEGORY_ID", 	Align:"Left",      Width:1,   Edit:0, Hidden:true }
        ...
        function setOspDisplayCategory(ospCatNmParams, ospCatCdParams, ospRepParams, ospDispYnParams)
        {
            ...
            for (let idx=0; idx<ospCatCdList.length-1; idx++) {
                ...
                mySheet4.SetCellValue(rowIdx, "OSP_CATEGORY_FULL_NM", ospCatNmList[idx]);
        ...
        function addOspCategory() {
            ...
            if (rowCount < 99) {
                ...
                let targetUrl = '${ctx}/edi/product/ospDisplayCategoryPop.do?closeFlag=1&l3Cd='
...
//						}
				...
				*/
				...
				if(mySheet4.RowCount() > 0) {
					for(let i=1; i<mySheet4.RowCount()+1; i++){
						ospCatCdVal += "," + mySheet4.GetCellValue(i,"OSP_CATEGORY_ID");

						ospCatCdVal += mySheet4.GetCellValue(i,"OSP_CATEGORY_REP") === "Y" ? "^REP" : "";
					}
									...
									<td colspan="3">
										...
										<div style="overflow:hidden;">
											<div style="padding:0 63px 0 0;">
												...
												<a href="#" class="btn" style="float:right;" onclick="javascript:addEcStandardCategory('LTMT,TOYS', 'Y');"><span>등록</span></a>
												<div id="ibsheet3"></div>
											</div>
										</div>
										<!-- 200306 EC전용 카테고리 END -->

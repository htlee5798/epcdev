...
<title>'명절선물 안주고 안받기' 캠페인 </title>


<script>

	function closeWin(cookiename)  {
	    setCookieToday(cookiename, 'popcookie201401140' , 1);        
	    top.close();
	}
	...
	<tr>
		<td bgcolor=ffffff>
			<table cellspacing=0 cellpadding=0 border=0 width=100%>
				<TR>
				<img src="/images/epc/popup/201401140popUp.JPG" usemap="#aa"  border="0" >				
				</td>			
			</TR>
			<TR>
			<td>
				<input type="checkbox" id="user_chk"  value="" onclick="closeWin('popcookie201401140');"> 이 메세지를 더이상 표시하지 않음.
			</td>
			</TR>
			</table>
			</td>

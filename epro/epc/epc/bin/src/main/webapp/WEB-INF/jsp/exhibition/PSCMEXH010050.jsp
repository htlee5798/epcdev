...
<script language="javascript" type="text/javascript">
	...
	ibdata.Cols = [
      ...
      , {SaveName:"adminName", 			Header:"성명",             	Type:"Text",   		Align:"Center",   Width:80,  		Cursor:'pointer', Color:'blue', FontUnderline:true} 
	  , {SaveName:"adminTypeName",  	Header:"관리자유형",   	Type:"Text",          	Align:"Center",   Width:200,  	Edit:0} 
	  , {SaveName:"strName",           		Header:"소속점포명",   	Type:"Text",         	Align:"Center",   Width:200, 	Edit:0}
	  , {SaveName:"adminId",   	 			Header:"",       				Type:"Text",       	Align:"Center",   Width:0,			Edit:0, Hidden:true}
	  , {SaveName:"loginId",  				Header:"",                    	Type:"Text",        	Align:"Center",   Width:0,	 		Edit:0, Hidden:true}
	];
...
function goPage(currentPage) {
	var url = '<c:url value="/exhibition/mdSearch.do"/>';
	...
	loadIBSheetData(mySheet, url, currentPage, '#dataForm', param);	
}
...
function mySheet_OnClick(Row, Col, Value, CellX, CellY, CellW, CellH) {
	...
	if( Row > 0 &&  mySheet.ColSaveName(Col) == "adminName"){	//제목을 클릭했을 때(Row가 0보다 큰 조건은 Header를 클릭했을 때는 상세팝업으로 이동하지 않도록 하기 위함이다.)
		$('#regId',opener.document).val(mySheet.GetCellValue(Row, "adminId"));
		$('#regName',opener.document).val(mySheet.GetCellValue(Row, "adminName"));
		self.close();
	}
}
		...
		<div class="wrap_search">
			<div class="bbs_search">
		  	<ul class="tit">
		  	 ...
		  	 <ul>
		   		<li>
		   			<table class="bbs_search" width="100%" border="0" cellpadding="0" cellspacing="1" summary="조회조건">
							<col width="20%">
							<col width="30%">
							<col width="20%">
							<col width="30%">
						<tr>
							...
							<td>
								<select name="adminTypeCd" id="adminTypeCd" style="width:95%"  title="관리자유형">	
			 						...
			 						<epcutl:option codeGroupId="SM032" selectedCd="${code}" />
								</select>	
							</td>
							<th>성명</th>

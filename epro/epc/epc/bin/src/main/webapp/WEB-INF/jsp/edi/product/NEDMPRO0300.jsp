...
<script id="dataListTemplate" type="text/x-jquery-tmpl">
	<tr class="r1"  bgcolor=ffffff>
		...
		<td align="center"><c:out value="\${docNo1}" /></td>
		<td align="center"><c:out value="\${docNo2}" /></td>
		<td align="center"><c:out value="\${docNo3}" /></td>
					...
					<div class="bbs_search">
						...
						<table class="bbs_search" cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
								...
								<th>행사기간</th>
								<td>
									<input type="text" class="day" name="ofsdt" id="ofsdt" style="width:80px;" value="<c:out value='${today}'/>" disabled> <img src="/images/epc/layout/btn_cal.gif" class="middle" onClick="openCal('searchForm.ofsdt');" style="cursor:hand;" />
									~

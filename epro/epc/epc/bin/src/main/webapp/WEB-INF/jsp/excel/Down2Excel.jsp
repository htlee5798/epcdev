...
<%
	...
	System.out.println("Down2Excel Version ===> " + com.ibleaders.ibsheet7.util.Version.getVersion());
	...
	// (설정하지 않거나 공백으로 설정 시 EUC-KR로 처리됩니다.)
...
//	ibExcel.setWebRoot(webRootPath);
	...
	//====================================================================================================
//	String tempRoot = "C:/dev/server/apache-tomcat-7.0.54-windows-x64/apache-tomcat-7.0.54/webapps/ROOT";

		...
		<article id="contents" style="padding-top:5px;">
			<div class="wrap-in">
				<section class="prod-detail">
					<h1 class="detail-type">${newProdDetailInfo.prodNm}</h1>
					<div class="prod-detail-info clear-after">
						<div class="flt-left">
							<div class="wrap-thumb">
								<div class="thumb-bigsize">
									<img id="imgBigSize" src="" alt="${newProdDetailInfo.prodNm}" class="thumb">
								</div>
										...
										<div class="wrap-thumb-slist">
											<ul class="thumb-slist-remote clear-after">
												<c:forEach  items="${onlineImageList}" var="imageFile"  varStatus="index" >
													<li><a href="#"><img src="${imagePath}/${subFolderName }/${imageFile}"  class="thumb imgStoB"></a></li>
												</c:forEach>
											</ul>
										</div>
									</div>
							...
							<fieldset>
								...
								<div class="wrap-info">
									<div class="prod-relation-info">
										...
										<div class="relation-price">
											...
											<dl>
												<dt>판매가</dt>
												<dd>
													<span class="num-n"><em><fmt:formatNumber value="${newProdDetailInfo.norProdSalePrc }" pattern="#,###" /></em></span>
									...
									<div class="prod-decision-price">
										구매예정금액
										<span class="num-n"><strong><fmt:formatNumber value="${newProdDetailInfo.norProdSalePrc }" pattern="#,###" /></strong> <span class="won">원</span></span>
									</div>
			...
			<div class="wrap-even"><div class="wrap-in-only">
				<section class="prod-dcomment">
					...
					<section class="wrap-tab-cont" id="tab01">
						...
						<div class="prod-dbanner">${newProdDetailInfo.prodDesc }</div>
						<div class="tbl-lst-v">
							<table>
								<caption></caption>
								<colgroup>
								...
								<tbody>
									<tr>
										...
										<td>${newProdDetailInfo.sellCd}</td>
									</tr>
									<c:forEach  items="${norProdDetailList}" var="norProdDetailInfo"  varStatus="index" >
										<tr>
											<th scope="row">${norProdDetailInfo.COL_NM}</th>
											<td>${norProdDetailInfo.COL_VAL}</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
						...
						<div class="tbl-lst-v">
							<table>
								...
								<tbody>
									<tr>
										<th scope="row" class="ksc"><img src="${frontUrl}/v3/images/layout/img_kcs.gif" alt="KCS인증마크" ><c:out value="${kcProdDetailList[0].INFO_GRP_NM}"/></th>
										<td>
		...
		<div class="container">
			...
			<div class="contents">
				<div class="txtimginfo-w first">
					<ul>
						<li class="imginfo w100"><img src="${frontUrl}/v3/images/temp/temp_card3.jpg" alt="" /></li>
						<li  class="txtinfo">
							<ul class="bul-circle">
				...
				<div class="txtimginfo-w">
					<ul>
						<li class="imginfo w100"><img src="${frontUrl}/v3/images/temp/temp_card4.jpg" alt="" /></li>
						<li  class="txtinfo">
							<ul class="bul-circle">
								<li>5만원 이상 최대 3개월 무이자 할부</li>
								<li>10만원 이상 최대 5개월 무이자 할부</li>
				...
				<div class="txtimginfo-w">
					<ul>
						<li class="imginfo w100"><img src="${frontUrl}/v3/images/temp/temp_card6.jpg" alt="" /></li>
						<li  class="txtinfo">
							<ul class="bul-circle">
								<li>5만원 이상 최대 3개월 무이자 할부</li>
							</ul>
				...
				<div class="txtimginfo-w">
					<ul>
						<li class="imginfo w100"><img src="${frontUrl}/v3/images/temp/temp_card7.jpg" alt="" /></li>
						<li  class="txtinfo">
							<ul class="bul-circle">
								<li>5만원 이상 최대 3개월 무이자 할부</li>
								<li>10만원 이상 최대 5개월 무이자 할부</li>
		...
		<div class="container">
			...
			<div class="contents">
				<div class="txtimginfo first">
					<ul>
						<li class="imginfo"><img src="${frontUrl}/v3/images/temp/temp_card1.jpg" alt="" /></li>
						<li  class="txtinfo">
				...
				<div class="txtimginfo">
					<ul>
						<li class="imginfo"><img src="${frontUrl}/v3/images/temp/temp_card2.jpg" alt="" /></li>
						<li  class="txtinfo">
				...
				<div class="tbl-lst-grade">
					<table>
						...
						<tr>
							...
							<td><img src="${frontUrl}/v3/images/layout/img_grade.jpg" alt="VIP"></td>
							<td><img src="${frontUrl}/v3/images/layout/img_grade2.jpg" alt="최우수"></td>
							<td><img src="${frontUrl}/v3/images/layout/img_grade3.jpg" alt="우수"></td>
							<td><img src="${frontUrl}/v3/images/layout/img_grade4.jpg" alt="일반"></td>
						  </tr>
						<tr>

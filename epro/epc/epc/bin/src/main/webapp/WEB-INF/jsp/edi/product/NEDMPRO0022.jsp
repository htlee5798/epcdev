				...
				<div class="wrap_search">
								...
								<c:forEach items="${onlineImageList}" var="imageFile"
									...
									<tr id="image_row_${index.count}" name="image_row">
										<td align="center">
											...
											src='${imagePathOnline}/${subFolderName }/${imageFile }?currentSecond=${currentSecond}'
											name="ImgPOG1f" id="image_1_500">
										</td>
										<td align="center"><img width="95px"
											src='${imagePathOnline}/${subFolderName }/${imageFile }_250.jpg?currentSecond=${currentSecond}'
											name="ImgPOG1f" id="image_1_250"></td>
										<td align="center"><img width="95px"
											src='${imagePathOnline}/${subFolderName }/${imageFile }_208.jpg?currentSecond=${currentSecond}'
											name="ImgPOG1f" id="image_1_208"></td>
										<td align="center"><img
											src='${imagePathOnline}/${subFolderName }/${imageFile }_120.jpg?currentSecond=${currentSecond}'
											name="ImgPOG1f" id="image_1_120"></td>
										<td align="center"><img
											src='${imagePathOnline}/${subFolderName }/${imageFile }_90.jpg?currentSecond=${currentSecond}'
											name="ImgPOG1f" id="image_1_90"></td>
										<td align="center"><img
											src='${imagePathOnline}/${subFolderName }/${imageFile }_80.jpg?currentSecond=${currentSecond}'
									...
									<tr id="submit_row_${index.count}" name="submit_row">
										<td colspan="6" align="right" style="padding-right: 40px">
											<c:if test="${param.mode ne 'view'}">
												...
												&nbsp;&nbsp;
												<a href="javascript:deleteImageRow('${imageFile}')"
									...
									<tr id="wide_submit_row_${index.count}" name="wide_submit_row">
										<td colspan="6" align="right" style="padding-right: 40px">
											...
											<a href="javascript:submitOnlineWideImage();" class="btn"><span><spring:message
															code="button.common.save" /></span></a>
															&nbsp;&nbsp;&nbsp;
												<a href="javascript:deleteWideImageRow('${wideImageFile}')"
													class=btn name='rowDelete'><span><spring:message
															code="button.common.delete" /></span></a>
											</c:if>
										</td>
					...
					<form name="offlineImageForm" id=offlineImageForm
						...
						<input type="hidden" name="pgmId" id="pgmId"
							...
							value="${prodDetailVO.prodImgId}" /> <input type="hidden"
							...
							<table class="bbs_search" cellpadding="0" cellspacing="0"
									...
									<c:forEach var="list" items="${prodVarAttList}"
										...
										<tr>
											<td align="left" colspan="3"
												...
												value="<c:out value="${list.variant}" />" /> <b>${list.attNm}</b>
											</td>
										</tr>
										<tr>
											<td align="center"><img width="95px"
												src="${imagePath}/${imagePathSub}images/edi/offline/${subFolderName }/${list.prodImgId}.1.jpg?currentSecond=${currentSecond}"
												onerror="setDefaultImage(this);" name="ImgPOG1f"></td>
											<td align="center"><img width="95px"
												src="${imagePath}/${imagePathSub}images/edi/offline/${subFolderName }/${list.prodImgId}.2.jpg?currentSecond=${currentSecond}"
												onerror="setDefaultImage(this);" name="ImgPOG1f"></td>

											<td align="center"><img width="95px"
												src="${imagePath}/${imagePathSub}images/edi/offline/${subFolderName }/${list.prodImgId}.3.jpg?currentSecond=${currentSecond}"
												onerror="setDefaultImage(this);" name="ImgPOG1f"></td>
										</tr>
										<tr>
											<td align="center"><input type="file"
												name="${list.prodImgId}_front" /> <input type="hidden"
											...
											<td align="center"><input type="file"
												name="${list.prodImgId}_side" /> <input type="hidden"
												id="prodImgIdAl" name="prodImgIdAl"
												value="<c:out value="${prodDetailVO.prodImgId}" />" /> <input
												type="hidden" id="variantAl" name="variantAl"
												value="<c:out value="${list.variant}" />" /></td>
											...
											<td align="center"><input type="file"
												name="${list.prodImgId}_top" /> <input type="hidden"
												id="prodImgIdAl" name="prodImgIdAl"
												value="<c:out value="${prodDetailVO.prodImgId}" />" /> <input
												type="hidden" id="variantAl" name="variantAl"
												value="<c:out value="${list.variant}" />" /></td>
								...
								<c:if test="${empty prodVarAttList}">
									...
									<c:if test="${prodDetailVO.newProdGenDivnCd ne 'KOR'}">
										<tr>
											<td align="center"><img width="95px"
												src="${imagePath}/${imagePathSub}images/edi/offline/${subFolderName}/${prodDetailVO.prodImgId}000.1.jpg?currentSecond=${currentSecond}"
												onerror="setDefaultImage(this);" name="ImgPOG1f"></td>
											<td align="center"><img width="95px"
												src="${imagePath}/${imagePathSub}images/edi/offline/${subFolderName}/${prodDetailVO.prodImgId}000.2.jpg?currentSecond=${currentSecond}"
												onerror="setDefaultImage(this);" name="ImgPOG1f"></td> 

											<td align="center"><img width="95px"
												src="${imagePath}/${imagePathSub}images/edi/offline/${subFolderName}/${prodDetailVO.prodImgId}000.3.jpg?currentSecond=${currentSecond}"
												onerror="setDefaultImage(this);" name="ImgPOG1f"></td>
										</tr>
									</c:if>

...
<script>
	...
	function popupSearch(tbName1, tbName2, tbName3){		
		...
		form.staticTableBodyValue.value = "<CAPTION>매입정보 점포상품별 현황표<br>"+
				...
				<div class="wrap_search">
					...
					<div class="bbs_search">
						...
						<tr>
							...
							<th colspan="2"><span class="star"><font color="blue"></font></span></th>
				 <!-- 		<th colspan="2"><span class="star"><font color="blue">전체상품 낱개기준</font></span></th>
				 -->
						</tr>
						<tr>
							<th>협력업체 코드</th>
					...
					<div class="bbs_list">
						...
						<c:if test="${not empty buyList }">
							<c:forEach items="${buyList}" var="list" varStatus="index" >
								...
								<c:set var="tot_sum2" value="${tot_sum1 + list.TOT_PRC }" />
								<c:set var="tot_sum3" value="${tot_sum1 + list.BUY_QTY }" />
								<c:set var="tot_sum4" value="${tot_sum1 + list.BUY_BUY_PRC }" />

...
<body>
<form name="dataForm" id="dataForm" action="${ctx }/edi/product/brand.do" method="post">
	...
	<div class="bbs_search">
		...
		<table class="bbs_search" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				...
				<td><input type="text" name="brandName" value="${param.brandName }" style="width:150px;" /></td>
			</tr>	
        </table> 
	</div>
						...
						<table class="bbs_list" cellpadding="0" cellspacing="0" border="0" id="testTable2">
							...
							<c:forEach items="${brandList}" var="brand" varStatus="index" >
								<tr class="r1" >
									...
									<td  align="center">
										<a href="javascript:selectBrand('${brand.categoryCode}', '${brand.categoryName}')">
											${brand.categoryCode}
										</a>
									</td>
									<td aling=left>&nbsp;  ${brand.categoryName }</td>
								</tr>
							</c:forEach>

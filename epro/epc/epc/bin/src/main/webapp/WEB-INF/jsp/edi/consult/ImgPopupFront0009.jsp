...
<script>
	...
	function closeWin(cookiename)  {
	    setCookieToday(cookiename, 'popcookie201308280' , 1);        
	    top.close();
	}
	...
	<tr>
		<td bgcolor=ffffff>
			<table cellspacing=0 cellpadding=0 border=0 width=100%>
				<TR>
				<img src="/images/epc/popup/201308280popUp.jpg"  border="0" WIDTH="400" HEIGHT="550">
				</td>			
			</TR>
			<TR>
			<td>
				<input type="checkbox" id="user_chk" name="user_chk" value="" onclick="closeWin('popcookie201308280');"> 이 메세지를 더이상 표시하지 않음.
			</td>
			</TR>
			</table>
			</td>

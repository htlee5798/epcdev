...
<script>
	...
	function popupSearch(tbName1, tbName2){		
		...
		form.staticTableBodyValue.value = "<CAPTION>배달정보  완료등록 현황표<br>"+
	...
	function printText(){
		...
		form.action  = "<c:url value='/edi/delivery/PEDMDLY0003Text.do'/>";
		form.submit();	
					...
					<c:if test="${not empty deliveryList }">
						...
						<c:forEach items="${deliveryList}" var="list" varStatus="index" >
							<tr class="r1">
							    ...
							    <td align="left" rowspan="3">&nbsp;${list.DELI_STATUS_NM }</td>
							    <td align="left" rowspan="3">&nbsp;${list.UDELI_REASON_NM }</td>
							</tr>
							<tr class="r1">
							...
							<tr class="r1">
								...
								<td align="center" colspan="2">${list.DELI_STATUS_DY }</td>
							</tr>
							<tr class="r1">

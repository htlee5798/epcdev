...
<form name="MyForm"  id="MyForm" method="post"  action="<c:url value='/epc/edi/consult/NEDMCST0310Agree.do'/>">
	...
	<div id="con_wrap">
		...
		-->	
			...
			<div class="box_gray box_login">
				<p class="txt_btxt"><!-- 고객님의 --> <em><spring:message code='text.consult.field.reqBmanNo'/><em></p>
...
<!-- 
 ...
 -->
 	...
 	<div class="pwd_find"><spring:message code='text.consult.field.bmanNoInfo'/></div>

	...
	function doSearch() {
		...
		if (dateValid()) {
			$.ajax({
				...
				dataType : 'html',
				async : false,
				url : '<c:url value="/edi/buy/NEDMBUY0050Select.json"/>',
...
function doExcel(tbName1, tbName2, tbName3){		
		...
		var bodyValue = "";
		bodyValue += "<CAPTION><spring:message code='text.buy.field.buySlipNoDetailList'/><br>";
	...
	function printText() {
		...
		$("#searchForm").attr("action", "<c:url value='/edi/buy/NEDMBUY0050Text.do'/>");
		$("#searchForm").submit();	
	}
			...
			<div id="wrap_menu">
						...
						<ul class="tit">
							...
							<li class="btn">
								<a href="#" class="btn" onclick="doSearch();"><span><spring:message code="button.common.inquire"/></span></a>
 								<a href="#" class="btn" onclick="doExcel('headTbl');"><span><spring:message code="button.common.excel"/></span></a> 
				...
				<div class="wrap_con">
					...
					<div class="bbs_list">
						...
						<div class="datagrade_nontitle_scroll" id="dataList">
			...
			<div id="footbox">
				...
				<div class="location">
					<ul>
						...
						<li class="last"><spring:message code='epc.buy.menu.slipNoDetail' /></li>
					</ul>
				</div>
			</div>
		</div>

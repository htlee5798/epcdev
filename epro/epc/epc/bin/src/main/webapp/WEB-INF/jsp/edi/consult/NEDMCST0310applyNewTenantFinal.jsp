	...
	<form name="MyForm" action="<c:url value='/epc/edi/consult/NEDMCST0310insertStepApplyFinal.do'/>" method="post" id="MyForm">
		<div id="wrap">
			<div id="con_wrap">
									...
									<p class="td_p">
										<c:choose>
											<c:when test="${vendor.tSubteamCd=='15502'}">
			           							<spring:message code='text.consult.field.tSubteamCd15502'/>
			           						</c:when>
			           						<c:when test="${vendor.tSubteamCd=='00088'}">
			           							<spring:message code='text.consult.field.tSubteamCd00088'/>
			           						</c:when>           		
										</c:choose>	
		           				 	</p>
								</td>
								<th><p><spring:message code='text.consult.field.bmanNo'/></p></th>
								<td><p class="td_p"><c:out value='${ vendorSession.vendor.bmanNo }'/></p></td>
	           				 </tr>
						</tbody>
					</table>
				</div>
				...
				<div class="s_title mt20">
					<h2><spring:message code='text.consult.field.consultApplicantList'/></h2><br>
				</div>
				...
				<div class="s_title mt20">
					<h2><spring:message code='text.consult.field.consultList'/></h2><br>
				</div>
				...
				<div class="tb_v_common">
					<table cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<tbody>	
							<tr>									
								<th><p><spring:message code='text.consult.field.tenanMainProduct'/></p></th>
								<td><p class="td_p"><c:out value='${vendor.mainProduct}'/></p></td>
								<th><p><spring:message code='text.consult.header.asisMystorecnt'/></p></th>
								<td><p class="td_p">
										<c:out value='${vendor.asisMystorecnt}'/> 
							...
							<tr>
								<th><p><spring:message code='text.consult.header.wishStore'/></p></th>
								<td colspan="3"><p class="td_p"><c:out value='${vendor.wishStore}'/> <spring:message code='text.consult.header.gae'/></p></td>	
							</tr>
								...
								<td colspan="3">
									<c:if test="${not empty vendor.attachFileCode }">
										<span style="margin-left: 20px">
											<c:out value='${vendor.attachFileCode}'/>
										</span>&nbsp;
										
										<a href="javascript:downloadConsultDocumnet('<c:out value="${vendor.bmanNo}"/>')">
											<spring:message code='text.consult.field.download'/>
										</a>
										
										<c:if test="${gubunBlock =='N'}">
										
											<span style="margin-left: 50px">
												<a	href="javascript:deleteBusinessIntroduction('<c:out value="${vendor.bmanNo }"/>')">
						...
						<tbody>			
							<tr>
								<div class="box_etc_input">
									<textarea cols="122" rows="5" name="content" id="content"  readOnly	style="width: 828px; height: 40px;"><c:out value='${vendor.pecuSubjectContent}'/></textarea>
								</div>						
							</tr>														
				...
				<div class="tb_h_common_02">
					<table cellpadding="0" cellspacing="0" border="0" width="100%">
						<caption><spring:message code='text.consult.field.selfDiagnosis'/>(<spring:message code='text.consult.field.consultKind3'/>)</caption>
						<colgroup>
							<col width="100px">
							<col width="450px">
							<col width="100px">
				...
				<div class="tb_v_common">
					<table cellpadding="0" cellspacing="0" border="0" width="100%">						
						...
						<tbody>	
							<tr>							
								<th><p><spring:message code='text.consult.field.fieUpload'/><!-- 첨부파일  --></p></th>
								<td colspan="3">
									<c:if test="${not empty vendor.atchFileKindCd }">
										<span style="margin-left: 20px">
											<c:out value='${vendor.atchFileKindCd}'/>
										</span>&nbsp;
										<a href="javascript:downloadConsultDocumnet2('<c:out value="${vendor.bmanNo}"/>')">
											<spring:message code='text.consult.field.download'/>
										</a>
									</c:if>	
								</td>

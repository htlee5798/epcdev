...
<script language="JavaScript">
     function forwardValue(val,val2){

         opener.receiveProduct(val,val2);
		 window.close();
     }
     ...
     function doSearch() {
 		...
 		loadingMask(); 	
 		form.action  = "<c:url value='/edi/comm/PEDPCOM0002EstimateSearch.do'/>";
 		form.submit();	
 	}
...
<input type="hidden" id="pro_sele_val" name="pro_sele_val" value="${value }"/>
<div id="popup">
    <!------------------------------------------------------------------ -->
    <!--    title -->
    <!------------------------------------------------------------------ -->
	...
	<div class="bbs_search">
		...
		<table class="bbs_search" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				...
				<td><input type="text" name="inputProduct" value="${param.inputProduct }" style="width:150px;" onKeyDown="doKeyCheck();" />
							...
							<c:if test="${not empty productList }">
								...
								<c:forEach items="${productList}" var="list" varStatus="index" >
									<tr class="r1">
										...
										<td align=center><a href="javascript:forwardValue('${list.PROD_CD }','${list.PROD_NM}');">${list.PROD_CD }</a> </td>
										<td>&nbsp; ${list.PROD_NM } </td>
									</tr>

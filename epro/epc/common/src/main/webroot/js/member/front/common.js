...
{
	var openurl = _LMMembersAppSSLUrl + "/imember/login/ssoLoginPop.do?sid=" + sid + "&returnURL=" + encodeURIComponent(returnURL);
	var popup = window.open(openurl, "ssoLoginPop", "toolbar=no,location=no,directories=no,status=no,scrollbars=no,resizable=yes, menubar=no,width=500,height=565,dependent=yes");
//
//	var frm = $("<form>").attr({"name":"onLoginMakingParamFrm", "action":openurl, "method":"post", "target":"ssoLoginPop"})
//			.css({"margin":"0px", "padding":"0px"}).appendTo("body");
//	$("<input>").attr({"name":"sid", "type":"hidden"}).val(sid).appendTo(frm);
...
function logout(returnURL, linkURL)
{
	...
	var url = _LMMembersAppSSLUrl + (!linkURL ? "/imember/login/ssoLogoutPop.do" : linkURL) + "?returnURL=" + encodeURIComponent(returnURL);
	$("<iframe>").attr({"src":url}).css({"width":"0px", "height":"0px"}).appendTo("body");
	
//	var frm = $("<form>").attr({"name":"logoutIframeForm", "action":_LMMembersAppSSLUrl + "/mlogin/ssoLogoutPop.do", "method":"post", "target":"tmpIframe"})
//			.css({"margin":"0px", "padding":"0px"}).appendTo("body");
//	$("<input>").attr({"name":"returnURL", "type":"hidden"}).val(returnURL).appendTo(frm);
//
	frm.submit();
...
{
    location.href =  _LMAppUrl+"/mlogin/noMemLoginSeed.do?sid=" + sid + "&returnURL=" + returnURL;
...
{
    location.href =  _LMAppUrl+"/mlogin/searchOrderNoMemLogin.do?returnURL=" + returnURL;
}
...
{
	var openurl =  _LMAppUrl+"/mlogin/searchOrderNoMemLogin.do?sid=" + sid + "&returnURL=" + returnURL;
...
{
	//location.href = _LMMembersAppSSLUrl+"/user/registMemCheckForm.do?sid="+sid+"&returnURL="+ returnURL;
...
{
	//location.href = _LMMembersAppSSLUrl+"/user/registMemChangeForm.do?sid="+sid+"&returnURL="+ returnURL;
...
{
	//location.href = _LMMembersAppSSLUrl+"/user/registFgnChangeForm.do?sid="+sid+"&returnURL="+ returnURL;
...
{
	//location.href = _LMMembersAppSSLUrl+"/user/registCorChangeForm.do?sid="+sid+"&returnURL="+ returnURL;
...
{
	//location.href = _LMMembersAppSSLUrl+"/user/changePasswordForm.do?sid="+sid+"&returnURL="+ returnURL;
...
{
	//location.href = _LMMembersAppSSLUrl+"/user/searchIdPasswordPreForm.do?sid="+sid+"&returnURL="+ returnURL;
...
{
	//location.href = _LMMembersAppSSLUrl+"/user/registWithDrawGuide.do?sid="+sid+"&returnURL="+ returnURL;

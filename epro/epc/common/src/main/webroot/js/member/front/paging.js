 ...
 * @return
 */
function setLMPaging(totalCntStr, rowsPerPageStr, curPageStr, funcName, pagingDivId ) {
	var totalCnt = 0;
	var curPage = 0;
	var rowsPerPage = 0;
	try{
		...
		document.getElementById(pagingDivId).innerHTML = render(totalCnt, curPage, rowsPerPage, funcName);
	}catch(e){
		alert(e);
	}
 ...
 * @param funcName
 */
function render(totalCnt, curPage, rowsPerPage, funcName){

(function(root, factory) {
		...
		return {
			...
			focusEvent: function() {
				var $option = $('.basket-option'),
					...
					_option = $baksetBtn.data('option-yn'), //상품을 한번이라도 담은적 있는지 여부
					_optionCloseClass = '.btn-ico-close', //닫기 버튼
					_completeCloseClass = '.btn-close', //취소 버튼
					$nextHiddenBtn = $('<a href="javascript:;" class="blind">Next hidden button</a>');

				//장바구니 담기 레이어 팝업 안 첫번째 요소로 진입
				...
				if (_option == 'Y') {
					var $body = $('body'),
						_layerToastClasee = '.layerpop-toast-btm';// 장바구니 상품 확인 여부를 묻는 레이어 팝업 영역
	...
	*/
	...
	return {
		...
		//basketKeyboardHandler : basketKeyboardHandler,

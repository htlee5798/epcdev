...
function SetEnvironment()        
{
	...
	if( ini_IsVistaAfter == true )
	{
		...
		if( ini_IsNewVerOCX == true )
			PLUGIN_CLASSID = "<OBJECT ID=INIpay CLASSID=CLSID:24F6E6A8-852C-45A8-ADD3-C4AB0D6FD231 class=blind width=0 height=0 CODEBASE=http://plugin.inicis.com/wallet61/INIwallet61_win8.cab#Version=1,0,0,5 onerror=OnErr()></OBJECT>";
		else PLUGIN_CLASSID = "<OBJECT ID=INIpay CLASSID=CLSID:24F6E6A8-852C-45A8-ADD3-C4AB0D6FD231 class=blind width=0 height=0 CODEBASE=http://plugin.inicis.com/wallet61/INIwallet61_vista.cab#Version=1,0,0,1 onerror=OnErr()></OBJECT>";

...
var starVote = function(objId) {
	...
	var backPosLoc = function(starObj, act) {
		...
		if( jQuery(starObj).css('background-position') ) {
			...
			if( act == 'off' ) {
				if( backPos == '0px -16px' || backPos == '0% -16px' ) {
					jQuery(starObj).css('background-position', '0px 0px');
				}
			} else {
				if( backPos == '0px 0px' || backPos == '0% 0%' ) {
			...
			if( act == 'off' ) {
				if( (backPosX == '0px' && backPosY == '-16px') || (backPosX == '0%' && backPosY == '-16px') ) {
					jQuery(starObj).css({
				...
				if( (backPosX == '0px' && backPosY == '0px') ||  (backPosX == '0%' && backPosY == '0px')) {
					jQuery(starObj).css({
						'background-position-x':'0px',
...
//							}
							...
							if(typeof goProdZoom != "undefined") {
								goProdZoom(
									jQuery(this).attr('cateId'),
									jQuery(this).attr('prodCd'),
									jQuery(this).attr('itemCd'),
									jQuery(this).attr('printYn'),
									jQuery(this).attr('adultYn'),
									jQuery(this).attr('mallDivnCd')
								);
							}

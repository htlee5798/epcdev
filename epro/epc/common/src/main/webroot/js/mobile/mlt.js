...
function fn_initl_mobilemultimedialist() {
	
	$.getJSON(contextPath + "/mobile/mlt/selectMobileMultimediaList.mdo", function(json) {
		var list_html = "";
 ...
 ******************************************************** */
 function fn_multimediaplay(index, atchFileId) {
	...
	$.getJSON(contextPath + "/mobile/mlt/getMultimediaFileList.mdo?atchFileId=" + atchFileId, function(json) {
...
function fn_getType(classification, extension){
	var type = "";

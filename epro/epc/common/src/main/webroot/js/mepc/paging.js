...
function getRenderHtml(totalCnt, fromPageNo, toPageNo, lastPageNo, curPage, previousPage, nextPage, funcName, rowsPerPage, gubun){
    ...
    if (curPage == 1) {
    	...
    	htmlString += "<span class=\"fst\" onclick=\"javascript:" + funcName + "(1);\" ><a href=\"#\"><img src=\"/images/mepc/layout/btn_first.gif\" alt=\"첫페이지\" class=\"middle\" /></a></span>";
    }
    
    // 이전 페이지 출력
    if(previousPage !='1'){
    	//htmlString += "<span class=\"pre\" onclick=\"javascript:" + funcName + "('" + previousPage + "');\" ></span>";
    	htmlString += "<span class=\"pre\" onclick=\"javascript:" + funcName + "('" + previousPage + "');\" ><a href=\"#\"><img src=\"/images/mepc/layout/btn_prev.gif\" alt=\"이전페이지\" class=\"middle\" /></a></span>";
    }else{
    ...
    if (curPage == nextPage) {
    	...
    	htmlString += "<span class=\"nxt\" onclick=\"javascript:" + funcName + "('" + nextPage + "');\" ><a href=\"#\"><img src=\"/images/mepc/layout/btn_next.gif\" alt=\"다음페이지\" class=\"middle\" /></a></span>";
    }
    ...
    if (curPage == lastPageNo) {
    	...
    	htmlString += "<span class=\"end\" onclick=\"javascript:" + funcName + "('" + lastPageNo + "');\" ><a href=\"#\"><img src=\"/images/mepc/layout/btn_end.gif\" alt=\"끝페이지\" class=\"middle\" /></a></span>";
    }

...
//for dialog - 와이즈그리드 가리기 위해 투명 iframe을 깐다
(function($){
...
(function(a) {
	...
	a.maskElement = function(d, c) {
		...
		var html = '<iframe class="loadmask" style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');"></iframe>';
			
		var e = a('<div class="loadmask">'+html+'</div>');

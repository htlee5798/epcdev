...
function getRenderHtml(totalCnt, fromPageNo, toPageNo, lastPageNo, curPage, previousPage, nextPage, funcName, rowsPerPage, gubun) {
    ...
    if (gubun == "1") {
	    ...
	    htmlString += "<select name=\"rowsPerPage\" id=\"rowsPerPage\" onChange=\"javascript:doSearch();\" class=\"select\" align=\"right\">";
	    htmlString += "	<option value=\"1000\" "+(rowsPerPage == 1000 ? 'selected':'')+">1000건</option>";
	    htmlString += "	<option value=\"2000\" "+(rowsPerPage == 2000 ? 'selected':'')+">2000건</option>";
	    htmlString += "	<option value=\"5000\" "+(rowsPerPage == 5000 ? 'selected':'')+">5000건</option>";
	    htmlString += "	<option value=\"10000\" "+(rowsPerPage == 10000 ? 'selected':'')+">10000건</option>";
	    htmlString += "</select>";
	    htmlString += "</span></p>";
...
function getRenderPageHtml(totalCnt, fromPageNo, toPageNo, lastPageNo, curPage, previousPage, nextPage, funcName, rowsPerPage, gubun) {
    ...
    // 첫 페이지
    if (curPage == 1) {
    	htmlString += "<img src=\"/images/pp/new/btn_a_first.png\" alt=\"맨처음\" align=\"middle\" />";
    } else {
    	//htmlString += "<span class=\"fst\" onclick=\"javascript:" + funcName + "(1);\" ></span>";
    	htmlString += "<a href=\"javascript:" + funcName + "(1);\"><img src=\"/images/pp/new/btn_a_first.png\" alt=\"맨처음\" align=\"middle\" /></a>";
    }
    
    // 이전 페이지 출력
    if (previousPage !='1') {
    	htmlString += "<a href=\"javascript:" + funcName + "('" + previousPage + "');\"><img src=\"/images/pp/new/btn_a_prev.png\" alt=\"이전\" align=\"middle\" /></a>";
    } else {
    	htmlString += "<img src=\"/images/pp/new/btn_a_prev.png\" alt=\"이전\" align=\"middle\" />";
    }
    ...
    // 이후 페이지 출력
    if (curPage == nextPage) {
        htmlString += "&nbsp;<img src=\"/images/pp/new/btn_a_next.png\" alt=\"다음\" align=\"middle\" />";
    } else {
    	htmlString += "&nbsp;<a href=\"javascript:" + funcName + "('" + nextPage + "');\"><img src=\"/images/pp/new/btn_a_next.png\" alt=\"다음\" align=\"middle\" /></a>";
    }


    // 마지막 페이지 출력
    if (curPage == lastPageNo) {
        htmlString += "<img src=\"/images/pp/new/btn_a_end.png\" alt=\"맨끝\" align=\"middle\" />";
    } else {
    	htmlString += "<a href=\"javascript:" + funcName + "('" + lastPageNo + "');\"><img src=\"/images/pp/new/btn_a_end.png\" alt=\"맨끝\" align=\"middle\" /></a>";
    }

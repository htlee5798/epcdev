...
if ( appliance_main_rolling ) throw new Error('[ixError] "appliance_main_rolling"가 이미 존재하여 충돌이 발생!');

var appliance_main_rolling = ( function ( $list , isAuto , w , type) {
...
var rolling1 = new appliance_main_rolling( $( 'div.dontwory' ) , false, 190 ,true );
var rolling2 = new appliance_main_rolling( $( 'div.hotissue_contents')  , true, 252 ,true );
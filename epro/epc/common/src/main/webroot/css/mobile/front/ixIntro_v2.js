...
$(function(){
	var _screenW = $(window).width(),
		_screenH = $(window).height() - ($('div.m-header').outerHeight() + $('div.m-menu').outerHeight()),
	...
	*/
	...
	_f1.css( 'height', _screenH*0.6132 + 'px' );
	_f2.css( 'height', _screenH*0.3868 + 'px' );
	...
	if ( _f1.height() > _mainBanner.height() ) {
		_mainBanner.css( 'margin-top' , (_f1.height()-_mainBanner.height())/2 + 'px' );
	}

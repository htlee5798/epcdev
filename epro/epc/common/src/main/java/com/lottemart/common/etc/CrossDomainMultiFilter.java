 ...
 */
public class CrossDomainMultiFilter extends MultipartFilter {

	public static final String[] exceptionUrl = {"/banner/banner/", "/category/basicCategory/"
												,"/newContents/insertDispImgBanner.do", "/promotion/eventMgt/"};
	/**
	...
	protected void doFilterInternal(
		...
		try {
			...
			if(fiterFlag){
				filterChain.doFilter(new RequestWrapper(processedRequest), response);     
			}else{

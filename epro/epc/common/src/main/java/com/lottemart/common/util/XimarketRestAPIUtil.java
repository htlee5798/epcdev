...
public class XimarketRestAPIUtil
{//11번가 기존 RestAPIUtil을 그대로 가져옴 바꾸는 부분은 oneapp.domain.url -> ximarket.domain.url
	private static final Logger logger = LoggerFactory.getLogger(XimarketRestAPIUtil.class);
	...
	{
		final String domain = ConfigUtils.getString("ximarket.domain.url");
